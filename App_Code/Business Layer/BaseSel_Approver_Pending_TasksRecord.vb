...
' Your customizations should be made in Sel_Approver_Pending_TasksRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_Approver_Pending_TasksRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_Approver_Pending_TasksRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_Approver_Pending_TasksView = Sel_Approver_Pending_TasksView.Instance
    ...
    Public Overridable Sub Sel_Approver_Pending_TasksRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_Approver_Pending_TasksRec As Sel_Approver_Pending_TasksRecord = CType(sender,Sel_Approver_Pending_TasksRecord)
        If Not Sel_Approver_Pending_TasksRec Is Nothing AndAlso Not Sel_Approver_Pending_TasksRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_Approver_Pending_TasksRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
...
#Region "Convenience methods to get/set values of fields"
	...
	''' This is a convenience method that provides direct access to the value of the record's sel_Approver_Pending_Tasks_.SSC_CompanyID field.
	''' </summary>
	Public Function GetSSC_CompanyIDFieldValue() As Int32
		Return CType(Me.GetValue(TableUtils.SSC_CompanyIDColumn).ToInt32(), Int32)
	End Function
...
#Region "Convenience methods to get field names"
	...
	''' </summary>
	Public Property SSC_CompanyID() As Int32
		Get 
			Return CType(Me.GetValue(TableUtils.SSC_CompanyIDColumn).ToInt32(), Int32)
		End Get
		Set (ByVal val As Int32) 
