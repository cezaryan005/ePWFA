...
' Your customizations should be made in Sel_CAR_Rpt_ActivityRem1Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_CAR_Rpt_ActivityRem1Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_CAR_Rpt_ActivityRem1Record
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_CAR_Rpt_ActivityRem1View = Sel_CAR_Rpt_ActivityRem1View.Instance
    ...
    Public Overridable Sub Sel_CAR_Rpt_ActivityRem1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_CAR_Rpt_ActivityRem1Rec As Sel_CAR_Rpt_ActivityRem1Record = CType(sender,Sel_CAR_Rpt_ActivityRem1Record)
        If Not Sel_CAR_Rpt_ActivityRem1Rec Is Nothing AndAlso Not Sel_CAR_Rpt_ActivityRem1Rec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_CAR_Rpt_ActivityRem1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
