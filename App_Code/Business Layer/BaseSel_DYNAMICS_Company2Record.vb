...
' Your customizations should be made in Sel_DYNAMICS_Company2Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_DYNAMICS_Company2Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_DYNAMICS_Company2Record
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_DYNAMICS_Company2View = Sel_DYNAMICS_Company2View.Instance
    ...
    Public Overridable Sub Sel_DYNAMICS_Company2Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_DYNAMICS_Company2Rec As Sel_DYNAMICS_Company2Record = CType(sender,Sel_DYNAMICS_Company2Record)
        If Not Sel_DYNAMICS_Company2Rec Is Nothing AndAlso Not Sel_DYNAMICS_Company2Rec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_DYNAMICS_Company2Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
