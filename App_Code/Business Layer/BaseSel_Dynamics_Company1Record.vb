...
' Your customizations should be made in Sel_Dynamics_Company1Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_Dynamics_Company1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="Sel_Dynamics_Company1View"></see> class.
''' </remarks>
''' <seealso cref="Sel_Dynamics_Company1View"></seealso>
''' <seealso cref="Sel_Dynamics_Company1Record"></seealso>

<Serializable()> Public Class BaseSel_Dynamics_Company1Record
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_Dynamics_Company1View = Sel_Dynamics_Company1View.Instance
    ...
    Public Overridable Sub Sel_Dynamics_Company1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_Dynamics_Company1Rec As Sel_Dynamics_Company1Record = CType(sender,Sel_Dynamics_Company1Record)
        If Not Sel_Dynamics_Company1Rec Is Nothing AndAlso Not Sel_Dynamics_Company1Rec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_Dynamics_Company1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
