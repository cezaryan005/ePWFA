...
' Your customizations should be made in Sel_SysSetupUsers_EmailRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_SysSetupUsers_EmailRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_SysSetupUsers_EmailRecord
	Inherits KeylessRecord
	Implements IUserIdentityRecord


	Public Shared Shadows ReadOnly TableUtils As Sel_SysSetupUsers_EmailView = Sel_SysSetupUsers_EmailView.Instance
    ...
    Public Overridable Sub Sel_SysSetupUsers_EmailRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_SysSetupUsers_EmailRec As Sel_SysSetupUsers_EmailRecord = CType(sender,Sel_SysSetupUsers_EmailRecord)
        If Not Sel_SysSetupUsers_EmailRec Is Nothing AndAlso Not Sel_SysSetupUsers_EmailRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_SysSetupUsers_EmailRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
