...
' Your customizations should be made in Sel_WASP_WF_ApproverRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WASP_WF_ApproverRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_WASP_WF_ApproverRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WASP_WF_ApproverView = Sel_WASP_WF_ApproverView.Instance
    ...
    Public Overridable Sub Sel_WASP_WF_ApproverRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_WASP_WF_ApproverRec As Sel_WASP_WF_ApproverRecord = CType(sender,Sel_WASP_WF_ApproverRecord)
        If Not Sel_WASP_WF_ApproverRec Is Nothing AndAlso Not Sel_WASP_WF_ApproverRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_WASP_WF_ApproverRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
