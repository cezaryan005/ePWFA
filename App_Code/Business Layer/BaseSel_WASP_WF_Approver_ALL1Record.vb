...
' Your customizations should be made in Sel_WASP_WF_Approver_ALL1Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WASP_WF_Approver_ALL1Record"></see> class.
''' </summary>
''' <remarks>
...
''' <seealso cref="Sel_WASP_WF_Approver_ALL1Record"></seealso>

<Serializable()> Public Class BaseSel_WASP_WF_Approver_ALL1Record
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WASP_WF_Approver_ALL1View = Sel_WASP_WF_Approver_ALL1View.Instance
    ...
    Public Overridable Sub Sel_WASP_WF_Approver_ALL1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_WASP_WF_Approver_ALL1Rec As Sel_WASP_WF_Approver_ALL1Record = CType(sender,Sel_WASP_WF_Approver_ALL1Record)
        If Not Sel_WASP_WF_Approver_ALL1Rec Is Nothing AndAlso Not Sel_WASP_WF_Approver_ALL1Rec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_WASP_WF_Approver_ALL1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
