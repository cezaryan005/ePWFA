...
' Your customizations should be made in Sel_WASP_WF_Approver_ALLRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WASP_WF_Approver_ALLRecord"></see> class.
''' </summary>
''' <remarks>
...
''' <seealso cref="Sel_WASP_WF_Approver_ALLRecord"></seealso>

<Serializable()> Public Class BaseSel_WASP_WF_Approver_ALLRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WASP_WF_Approver_ALLView = Sel_WASP_WF_Approver_ALLView.Instance
    ...
    Public Overridable Sub Sel_WASP_WF_Approver_ALLRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_WASP_WF_Approver_ALLRec As Sel_WASP_WF_Approver_ALLRecord = CType(sender,Sel_WASP_WF_Approver_ALLRecord)
        If Not Sel_WASP_WF_Approver_ALLRec Is Nothing AndAlso Not Sel_WASP_WF_Approver_ALLRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_WASP_WF_Approver_ALLRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
...
#Region "Convenience methods to get/set values of fields"
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WASP_WF_Approver_ALL_.W_U_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WASP_WF_Approver_ALL_.W_U_ID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WASP_WF_Approver_ALL_.W_U_User_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WASP_WF_Approver_ALL_.W_U_User_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WASP_WF_Approver_ALL_.W_U_Full_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WASP_WF_Approver_ALL_.W_U_Full_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WASP_WF_Approver_ALL_.W_R_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WASP_WF_Approver_ALL_.W_R_ID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WASP_WF_Approver_ALL_.W_R_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WASP_WF_Approver_ALL_.W_R_Name field.
	''' </summary>
...
#Region "Convenience methods to get field names"
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WASP_WF_Approver_ALL_.W_U_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WASP_WF_Approver_ALL_.W_U_User_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WASP_WF_Approver_ALL_.W_U_Full_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WASP_WF_Approver_ALL_.W_R_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WASP_WF_Approver_ALL_.W_R_Name field.
	''' </summary>
