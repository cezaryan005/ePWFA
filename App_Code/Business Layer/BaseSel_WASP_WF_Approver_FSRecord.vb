...
' Your customizations should be made in Sel_WASP_WF_Approver_FSRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WASP_WF_Approver_FSRecord"></see> class.
''' </summary>
''' <remarks>
...
''' <seealso cref="Sel_WASP_WF_Approver_FSRecord"></seealso>

<Serializable()> Public Class BaseSel_WASP_WF_Approver_FSRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WASP_WF_Approver_FSView = Sel_WASP_WF_Approver_FSView.Instance
    ...
    Public Overridable Sub Sel_WASP_WF_Approver_FSRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_WASP_WF_Approver_FSRec As Sel_WASP_WF_Approver_FSRecord = CType(sender,Sel_WASP_WF_Approver_FSRecord)
        If Not Sel_WASP_WF_Approver_FSRec Is Nothing AndAlso Not Sel_WASP_WF_Approver_FSRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_WASP_WF_Approver_FSRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
