...
' Your customizations should be made in Sel_WASP_WF_Approver_PO2Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WASP_WF_Approver_PO2Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="Sel_WASP_WF_Approver_PO2View"></see> class.
''' </remarks>
''' <seealso cref="Sel_WASP_WF_Approver_PO2View"></seealso>
''' <seealso cref="Sel_WASP_WF_Approver_PO2Record"></seealso>

<Serializable()> Public Class BaseSel_WASP_WF_Approver_PO2Record
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WASP_WF_Approver_PO2View = Sel_WASP_WF_Approver_PO2View.Instance
    ...
    Public Overridable Sub Sel_WASP_WF_Approver_PO2Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_WASP_WF_Approver_PO2Rec As Sel_WASP_WF_Approver_PO2Record = CType(sender,Sel_WASP_WF_Approver_PO2Record)
        If Not Sel_WASP_WF_Approver_PO2Rec Is Nothing AndAlso Not Sel_WASP_WF_Approver_PO2Rec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_WASP_WF_Approver_PO2Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
...
#Region "Convenience methods to get/set values of fields"
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WASP_WF_Approver_PO_.W_U_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WASP_WF_Approver_PO_.W_U_ID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WASP_WF_Approver_PO_.W_U_User_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WASP_WF_Approver_PO_.W_U_User_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WASP_WF_Approver_PO_.W_U_Full_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WASP_WF_Approver_PO_.W_U_Full_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WASP_WF_Approver_PO_.W_R_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WASP_WF_Approver_PO_.W_R_ID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's sel_WASP_WF_Approver_PO_.W_R_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's sel_WASP_WF_Approver_PO_.W_R_Name field.
	''' </summary>
...
#Region "Convenience methods to get field names"
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WASP_WF_Approver_PO_.W_U_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WASP_WF_Approver_PO_.W_U_User_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WASP_WF_Approver_PO_.W_U_Full_Name field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WASP_WF_Approver_PO_.W_R_ID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's sel_WASP_WF_Approver_PO_.W_R_Name field.
	''' </summary>
