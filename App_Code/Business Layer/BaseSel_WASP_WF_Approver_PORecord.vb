...
' Your customizations should be made in Sel_WASP_WF_Approver_PORecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WASP_WF_Approver_PORecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_WASP_WF_Approver_PORecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WASP_WF_Approver_POView = Sel_WASP_WF_Approver_POView.Instance
    ...
    Public Overridable Sub Sel_WASP_WF_Approver_PORecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_WASP_WF_Approver_PORec As Sel_WASP_WF_Approver_PORecord = CType(sender,Sel_WASP_WF_Approver_PORecord)
        If Not Sel_WASP_WF_Approver_PORec Is Nothing AndAlso Not Sel_WASP_WF_Approver_PORec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_WASP_WF_Approver_PORecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
