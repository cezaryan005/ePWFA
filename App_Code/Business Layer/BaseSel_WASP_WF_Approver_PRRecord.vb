...
' Your customizations should be made in Sel_WASP_WF_Approver_PRRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WASP_WF_Approver_PRRecord"></see> class.
''' </summary>
''' <remarks>
...
''' <seealso cref="Sel_WASP_WF_Approver_PRRecord"></seealso>

<Serializable()> Public Class BaseSel_WASP_WF_Approver_PRRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WASP_WF_Approver_PRView = Sel_WASP_WF_Approver_PRView.Instance
    ...
    Public Overridable Sub Sel_WASP_WF_Approver_PRRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_WASP_WF_Approver_PRRec As Sel_WASP_WF_Approver_PRRecord = CType(sender,Sel_WASP_WF_Approver_PRRecord)
        If Not Sel_WASP_WF_Approver_PRRec Is Nothing AndAlso Not Sel_WASP_WF_Approver_PRRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_WASP_WF_Approver_PRRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
