...
' Your customizations should be made in Sel_WASP_WF_CreatorRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WASP_WF_CreatorRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_WASP_WF_CreatorRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WASP_WF_CreatorView = Sel_WASP_WF_CreatorView.Instance
    ...
    Public Overridable Sub Sel_WASP_WF_CreatorRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_WASP_WF_CreatorRec As Sel_WASP_WF_CreatorRecord = CType(sender,Sel_WASP_WF_CreatorRecord)
        If Not Sel_WASP_WF_CreatorRec Is Nothing AndAlso Not Sel_WASP_WF_CreatorRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_WASP_WF_CreatorRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
