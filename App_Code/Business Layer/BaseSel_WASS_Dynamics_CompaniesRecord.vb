...
' Your customizations should be made in Sel_WASS_Dynamics_CompaniesRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WASS_Dynamics_CompaniesRecord"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="Sel_WASS_Dynamics_CompaniesView"></see> class.
''' </remarks>
''' <seealso cref="Sel_WASS_Dynamics_CompaniesView"></seealso>
''' <seealso cref="Sel_WASS_Dynamics_CompaniesRecord"></seealso>

<Serializable()> Public Class BaseSel_WASS_Dynamics_CompaniesRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WASS_Dynamics_CompaniesView = Sel_WASS_Dynamics_CompaniesView.Instance
    ...
    Public Overridable Sub Sel_WASS_Dynamics_CompaniesRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_WASS_Dynamics_CompaniesRec As Sel_WASS_Dynamics_CompaniesRecord = CType(sender,Sel_WASS_Dynamics_CompaniesRecord)
        If Not Sel_WASS_Dynamics_CompaniesRec Is Nothing AndAlso Not Sel_WASS_Dynamics_CompaniesRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_WASS_Dynamics_CompaniesRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
