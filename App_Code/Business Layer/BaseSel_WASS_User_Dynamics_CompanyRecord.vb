...
' Your customizations should be made in Sel_WASS_User_Dynamics_CompanyRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_WASS_User_Dynamics_CompanyRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_WASS_User_Dynamics_CompanyRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WASS_User_Dynamics_CompanyView = Sel_WASS_User_Dynamics_CompanyView.Instance
    ...
    Public Overridable Sub Sel_WASS_User_Dynamics_CompanyRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_WASS_User_Dynamics_CompanyRec As Sel_WASS_User_Dynamics_CompanyRecord = CType(sender,Sel_WASS_User_Dynamics_CompanyRecord)
        If Not Sel_WASS_User_Dynamics_CompanyRec Is Nothing AndAlso Not Sel_WASS_User_Dynamics_CompanyRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_WASS_User_Dynamics_CompanyRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
