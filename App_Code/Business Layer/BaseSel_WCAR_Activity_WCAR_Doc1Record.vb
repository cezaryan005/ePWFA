...
''' <summary>
''' The generated superclass for the <see cref="Sel_WCAR_Activity_WCAR_Doc1Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_WCAR_Activity_WCAR_Doc1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WCAR_Activity_WCAR_Doc1View = Sel_WCAR_Activity_WCAR_Doc1View.Instance
    ...
    Public Overridable Sub Sel_WCAR_Activity_WCAR_Doc1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Sel_WCAR_Activity_WCAR_Doc1Rec As Sel_WCAR_Activity_WCAR_Doc1Record = CType(sender,Sel_WCAR_Activity_WCAR_Doc1Record)
        Validate_Inserting()
        If Not Sel_WCAR_Activity_WCAR_Doc1Rec Is Nothing AndAlso Not Sel_WCAR_Activity_WCAR_Doc1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Sel_WCAR_Activity_WCAR_Doc1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Sel_WCAR_Activity_WCAR_Doc1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
