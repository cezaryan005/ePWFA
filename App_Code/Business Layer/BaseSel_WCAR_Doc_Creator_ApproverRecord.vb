...
''' <summary>
''' The generated superclass for the <see cref="Sel_WCAR_Doc_Creator_ApproverRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_WCAR_Doc_Creator_ApproverRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WCAR_Doc_Creator_ApproverView = Sel_WCAR_Doc_Creator_ApproverView.Instance
    ...
    Public Overridable Sub Sel_WCAR_Doc_Creator_ApproverRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Sel_WCAR_Doc_Creator_ApproverRec As Sel_WCAR_Doc_Creator_ApproverRecord = CType(sender,Sel_WCAR_Doc_Creator_ApproverRecord)
        Validate_Inserting()
        If Not Sel_WCAR_Doc_Creator_ApproverRec Is Nothing AndAlso Not Sel_WCAR_Doc_Creator_ApproverRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Sel_WCAR_Doc_Creator_ApproverRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Sel_WCAR_Doc_Creator_ApproverRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
