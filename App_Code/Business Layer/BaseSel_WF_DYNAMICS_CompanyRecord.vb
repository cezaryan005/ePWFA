...
''' <summary>
''' The generated superclass for the <see cref="Sel_WF_DYNAMICS_CompanyRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_WF_DYNAMICS_CompanyRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WF_DYNAMICS_CompanyView = Sel_WF_DYNAMICS_CompanyView.Instance
    ...
    Public Overridable Sub Sel_WF_DYNAMICS_CompanyRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Sel_WF_DYNAMICS_CompanyRec As Sel_WF_DYNAMICS_CompanyRecord = CType(sender,Sel_WF_DYNAMICS_CompanyRecord)
        Validate_Inserting()
        If Not Sel_WF_DYNAMICS_CompanyRec Is Nothing AndAlso Not Sel_WF_DYNAMICS_CompanyRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Sel_WF_DYNAMICS_CompanyRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Sel_WF_DYNAMICS_CompanyRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
