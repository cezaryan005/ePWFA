...
''' <summary>
''' The generated superclass for the <see cref="Sel_WF_Table_Fields1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="Sel_WF_Table_Fields1View"></see> class.
''' </remarks>
''' <seealso cref="Sel_WF_Table_Fields1View"></seealso>
''' <seealso cref="Sel_WF_Table_Fields1Record"></seealso>

<Serializable()> Public Class BaseSel_WF_Table_Fields1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WF_Table_Fields1View = Sel_WF_Table_Fields1View.Instance
    ...
    Public Overridable Sub Sel_WF_Table_Fields1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Sel_WF_Table_Fields1Rec As Sel_WF_Table_Fields1Record = CType(sender,Sel_WF_Table_Fields1Record)
        Validate_Inserting()
        If Not Sel_WF_Table_Fields1Rec Is Nothing AndAlso Not Sel_WF_Table_Fields1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Sel_WF_Table_Fields1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Sel_WF_Table_Fields1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
