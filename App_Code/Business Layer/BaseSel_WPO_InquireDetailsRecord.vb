...
''' <summary>
''' The generated superclass for the <see cref="Sel_WPO_InquireDetailsRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_WPO_InquireDetailsRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WPO_InquireDetailsView = Sel_WPO_InquireDetailsView.Instance
    ...
    Public Overridable Sub Sel_WPO_InquireDetailsRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Sel_WPO_InquireDetailsRec As Sel_WPO_InquireDetailsRecord = CType(sender,Sel_WPO_InquireDetailsRecord)
        Validate_Inserting()
        If Not Sel_WPO_InquireDetailsRec Is Nothing AndAlso Not Sel_WPO_InquireDetailsRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Sel_WPO_InquireDetailsRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Sel_WPO_InquireDetailsRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
