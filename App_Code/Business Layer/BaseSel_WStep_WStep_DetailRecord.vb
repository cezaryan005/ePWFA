...
''' <summary>
''' The generated superclass for the <see cref="Sel_WStep_WStep_DetailRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSel_WStep_WStep_DetailRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_WStep_WStep_DetailView = Sel_WStep_WStep_DetailView.Instance
    ...
    Public Overridable Sub Sel_WStep_WStep_DetailRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim Sel_WStep_WStep_DetailRec As Sel_WStep_WStep_DetailRecord = CType(sender,Sel_WStep_WStep_DetailRecord)
        Validate_Inserting()
        If Not Sel_WStep_WStep_DetailRec Is Nothing AndAlso Not Sel_WStep_WStep_DetailRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub Sel_WStep_WStep_DetailRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub Sel_WStep_WStep_DetailRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
