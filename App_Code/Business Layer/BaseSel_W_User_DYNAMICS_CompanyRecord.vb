...
' Your customizations should be made in Sel_W_User_DYNAMICS_CompanyRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="Sel_W_User_DYNAMICS_CompanyRecord"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="Sel_W_User_DYNAMICS_CompanyView"></see> class.
''' </remarks>
''' <seealso cref="Sel_W_User_DYNAMICS_CompanyView"></seealso>
''' <seealso cref="Sel_W_User_DYNAMICS_CompanyRecord"></seealso>

<Serializable()> Public Class BaseSel_W_User_DYNAMICS_CompanyRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As Sel_W_User_DYNAMICS_CompanyView = Sel_W_User_DYNAMICS_CompanyView.Instance
    ...
    Public Overridable Sub Sel_W_User_DYNAMICS_CompanyRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim Sel_W_User_DYNAMICS_CompanyRec As Sel_W_User_DYNAMICS_CompanyRecord = CType(sender,Sel_W_User_DYNAMICS_CompanyRecord)
        If Not Sel_W_User_DYNAMICS_CompanyRec Is Nothing AndAlso Not Sel_W_User_DYNAMICS_CompanyRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub Sel_W_User_DYNAMICS_CompanyRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
