...
''' <summary>
''' The generated superclass for the <see cref="SysPagesRecord"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="SysPagesTable"></see> class.
''' </remarks>
''' <seealso cref="SysPagesTable"></seealso>
''' <seealso cref="SysPagesRecord"></seealso>

<Serializable()> Public Class BaseSysPagesRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As SysPagesTable = SysPagesTable.Instance
    ...
    Public Overridable Sub SysPagesRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim SysPagesRec As SysPagesRecord = CType(sender,SysPagesRecord)
        Validate_Inserting()
        If Not SysPagesRec Is Nothing AndAlso Not SysPagesRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub SysPagesRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub SysPagesRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
