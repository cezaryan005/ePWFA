...
''' <summary>
''' The generated superclass for the <see cref="SysSetupWASSEmailRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseSysSetupWASSEmailRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As SysSetupWASSEmailTable = SysSetupWASSEmailTable.Instance
    ...
    Public Overridable Sub SysSetupWASSEmailRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim SysSetupWASSEmailRec As SysSetupWASSEmailRecord = CType(sender,SysSetupWASSEmailRecord)
        Validate_Inserting()
        If Not SysSetupWASSEmailRec Is Nothing AndAlso Not SysSetupWASSEmailRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub SysSetupWASSEmailRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub SysSetupWASSEmailRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
