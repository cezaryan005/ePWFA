...
' Your customizations should be made in View_WCPO_Canvass2Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="View_WCPO_Canvass2Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseView_WCPO_Canvass2Record
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As View_WCPO_Canvass2View = View_WCPO_Canvass2View.Instance
    ...
    Public Overridable Sub View_WCPO_Canvass2Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim View_WCPO_Canvass2Rec As View_WCPO_Canvass2Record = CType(sender,View_WCPO_Canvass2Record)
        If Not View_WCPO_Canvass2Rec Is Nothing AndAlso Not View_WCPO_Canvass2Rec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub View_WCPO_Canvass2Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
