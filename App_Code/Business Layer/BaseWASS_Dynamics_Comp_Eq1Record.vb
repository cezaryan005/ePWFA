...
''' <summary>
''' The generated superclass for the <see cref="WASS_Dynamics_Comp_Eq1Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWASS_Dynamics_Comp_Eq1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WASS_Dynamics_Comp_Eq1Table = WASS_Dynamics_Comp_Eq1Table.Instance
    ...
    Public Overridable Sub WASS_Dynamics_Comp_Eq1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WASS_Dynamics_Comp_Eq1Rec As WASS_Dynamics_Comp_Eq1Record = CType(sender,WASS_Dynamics_Comp_Eq1Record)
        Validate_Inserting()
        If Not WASS_Dynamics_Comp_Eq1Rec Is Nothing AndAlso Not WASS_Dynamics_Comp_Eq1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WASS_Dynamics_Comp_Eq1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WASS_Dynamics_Comp_Eq1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
