...
''' <summary>
''' The generated superclass for the <see cref="WAttach_TypeRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWAttach_TypeRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WAttach_TypeTable = WAttach_TypeTable.Instance
    ...
    Public Overridable Sub WAttach_TypeRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WAttach_TypeRec As WAttach_TypeRecord = CType(sender,WAttach_TypeRecord)
        Validate_Inserting()
        If Not WAttach_TypeRec Is Nothing AndAlso Not WAttach_TypeRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WAttach_TypeRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WAttach_TypeRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
