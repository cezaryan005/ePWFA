...
''' <summary>
''' The generated superclass for the <see cref="WCAR_ActivityRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWCAR_ActivityRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WCAR_ActivityTable = WCAR_ActivityTable.Instance
    ...
    Public Overridable Sub WCAR_ActivityRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WCAR_ActivityRec As WCAR_ActivityRecord = CType(sender,WCAR_ActivityRecord)
        Validate_Inserting()
        If Not WCAR_ActivityRec Is Nothing AndAlso Not WCAR_ActivityRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WCAR_ActivityRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WCAR_ActivityRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
