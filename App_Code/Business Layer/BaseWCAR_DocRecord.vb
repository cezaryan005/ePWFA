...
''' <summary>
''' The generated superclass for the <see cref="WCAR_DocRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWCAR_DocRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WCAR_DocTable = WCAR_DocTable.Instance
    ...
    Public Overridable Sub WCAR_DocRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WCAR_DocRec As WCAR_DocRecord = CType(sender,WCAR_DocRecord)
        Validate_Inserting()
        If Not WCAR_DocRec Is Nothing AndAlso Not WCAR_DocRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WCAR_DocRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WCAR_DocRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
