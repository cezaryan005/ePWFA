...
''' <summary>
''' The generated superclass for the <see cref="WCAR_Doc_Checker1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="WCAR_Doc_Checker1Table"></see> class.
''' </remarks>
''' <seealso cref="WCAR_Doc_Checker1Table"></seealso>
''' <seealso cref="WCAR_Doc_Checker1Record"></seealso>

<Serializable()> Public Class BaseWCAR_Doc_Checker1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WCAR_Doc_Checker1Table = WCAR_Doc_Checker1Table.Instance
    ...
    Public Overridable Sub WCAR_Doc_Checker1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WCAR_Doc_Checker1Rec As WCAR_Doc_Checker1Record = CType(sender,WCAR_Doc_Checker1Record)
        Validate_Inserting()
        If Not WCAR_Doc_Checker1Rec Is Nothing AndAlso Not WCAR_Doc_Checker1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WCAR_Doc_Checker1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WCAR_Doc_Checker1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
