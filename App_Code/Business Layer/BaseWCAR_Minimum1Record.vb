...
''' <summary>
''' The generated superclass for the <see cref="WCAR_Minimum1Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWCAR_Minimum1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WCAR_Minimum1Table = WCAR_Minimum1Table.Instance
    ...
    Public Overridable Sub WCAR_Minimum1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WCAR_Minimum1Rec As WCAR_Minimum1Record = CType(sender,WCAR_Minimum1Record)
        Validate_Inserting()
        If Not WCAR_Minimum1Rec Is Nothing AndAlso Not WCAR_Minimum1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WCAR_Minimum1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WCAR_Minimum1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
