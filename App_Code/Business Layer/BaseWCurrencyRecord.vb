...
''' <summary>
''' The generated superclass for the <see cref="WCurrencyRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWCurrencyRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WCurrencyTable = WCurrencyTable.Instance
    ...
    Public Overridable Sub WCurrencyRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WCurrencyRec As WCurrencyRecord = CType(sender,WCurrencyRecord)
        Validate_Inserting()
        If Not WCurrencyRec Is Nothing AndAlso Not WCurrencyRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WCurrencyRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WCurrencyRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
