...
''' <summary>
''' The generated superclass for the <see cref="WDoc_TypeRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWDoc_TypeRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WDoc_TypeTable = WDoc_TypeTable.Instance
    ...
    Public Overridable Sub WDoc_TypeRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WDoc_TypeRec As WDoc_TypeRecord = CType(sender,WDoc_TypeRecord)
        Validate_Inserting()
        If Not WDoc_TypeRec Is Nothing AndAlso Not WDoc_TypeRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WDoc_TypeRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WDoc_TypeRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
