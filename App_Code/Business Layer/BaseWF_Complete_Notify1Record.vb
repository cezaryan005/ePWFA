...
''' <summary>
''' The generated superclass for the <see cref="WF_Complete_Notify1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="WF_Complete_Notify1Table"></see> class.
''' </remarks>
''' <seealso cref="WF_Complete_Notify1Table"></seealso>
''' <seealso cref="WF_Complete_Notify1Record"></seealso>

<Serializable()> Public Class BaseWF_Complete_Notify1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WF_Complete_Notify1Table = WF_Complete_Notify1Table.Instance
    ...
    Public Overridable Sub WF_Complete_Notify1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WF_Complete_Notify1Rec As WF_Complete_Notify1Record = CType(sender,WF_Complete_Notify1Record)
        Validate_Inserting()
        If Not WF_Complete_Notify1Rec Is Nothing AndAlso Not WF_Complete_Notify1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WF_Complete_Notify1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WF_Complete_Notify1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
