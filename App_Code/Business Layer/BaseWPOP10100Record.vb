...
''' <summary>
''' The generated superclass for the <see cref="WPOP10100Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWPOP10100Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WPOP10100Table = WPOP10100Table.Instance
    ...
    Public Overridable Sub WPOP10100Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WPOP10100Rec As WPOP10100Record = CType(sender,WPOP10100Record)
        Validate_Inserting()
        If Not WPOP10100Rec Is Nothing AndAlso Not WPOP10100Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WPOP10100Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WPOP10100Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
