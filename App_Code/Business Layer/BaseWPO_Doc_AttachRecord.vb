...
''' <summary>
''' The generated superclass for the <see cref="WPO_Doc_AttachRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWPO_Doc_AttachRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WPO_Doc_AttachTable = WPO_Doc_AttachTable.Instance
    ...
    Public Overridable Sub WPO_Doc_AttachRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WPO_Doc_AttachRec As WPO_Doc_AttachRecord = CType(sender,WPO_Doc_AttachRecord)
        Validate_Inserting()
        If Not WPO_Doc_AttachRec Is Nothing AndAlso Not WPO_Doc_AttachRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WPO_Doc_AttachRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WPO_Doc_AttachRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
