...
''' <summary>
''' The generated superclass for the <see cref="WPO_StepRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWPO_StepRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WPO_StepTable = WPO_StepTable.Instance
    ...
    Public Overridable Sub WPO_StepRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WPO_StepRec As WPO_StepRecord = CType(sender,WPO_StepRecord)
        Validate_Inserting()
        If Not WPO_StepRec Is Nothing AndAlso Not WPO_StepRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WPO_StepRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WPO_StepRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
