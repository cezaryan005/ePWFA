...
' Your customizations should be made in WPO_Step_WPO_StepDetailRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="WPO_Step_WPO_StepDetailRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWPO_Step_WPO_StepDetailRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As WPO_Step_WPO_StepDetailView = WPO_Step_WPO_StepDetailView.Instance
    ...
    Public Overridable Sub WPO_Step_WPO_StepDetailRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim WPO_Step_WPO_StepDetailRec As WPO_Step_WPO_StepDetailRecord = CType(sender,WPO_Step_WPO_StepDetailRecord)
        If Not WPO_Step_WPO_StepDetailRec Is Nothing AndAlso Not WPO_Step_WPO_StepDetailRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub WPO_Step_WPO_StepDetailRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
