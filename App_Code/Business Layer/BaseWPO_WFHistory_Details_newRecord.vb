...
' Your customizations should be made in WPO_WFHistory_Details_newRecord.vb
...
''' <summary>
''' The generated superclass for the <see cref="WPO_WFHistory_Details_newRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWPO_WFHistory_Details_newRecord
	Inherits KeylessRecord
	

	Public Shared Shadows ReadOnly TableUtils As WPO_WFHistory_Details_newView = WPO_WFHistory_Details_newView.Instance
    ...
    Public Overridable Sub WPO_WFHistory_Details_newRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
        'Apply Initialize->Reading record formula only if validation is successful.
        	        Dim WPO_WFHistory_Details_newRec As WPO_WFHistory_Details_newRecord = CType(sender,WPO_WFHistory_Details_newRecord)
        If Not WPO_WFHistory_Details_newRec Is Nothing AndAlso Not WPO_WFHistory_Details_newRec.IsReadOnly Then
                End If
    End Sub
    
    	'Evaluates Initialize when->Inserting record formulas specified at the data access layer
    Public Overridable Sub WPO_WFHistory_Details_newRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
