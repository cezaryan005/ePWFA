...
''' <summary>
''' The generated superclass for the <see cref="WStepRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWStepRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WStepTable = WStepTable.Instance
    ...
    Public Overridable Sub WStepRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WStepRec As WStepRecord = CType(sender,WStepRecord)
        Validate_Inserting()
        If Not WStepRec Is Nothing AndAlso Not WStepRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WStepRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WStepRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
