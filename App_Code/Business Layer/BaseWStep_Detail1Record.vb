...
''' <summary>
''' The generated superclass for the <see cref="WStep_Detail1Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWStep_Detail1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WStep_Detail1Table = WStep_Detail1Table.Instance
    ...
    Public Overridable Sub WStep_Detail1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WStep_Detail1Rec As WStep_Detail1Record = CType(sender,WStep_Detail1Record)
        Validate_Inserting()
        If Not WStep_Detail1Rec Is Nothing AndAlso Not WStep_Detail1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WStep_Detail1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WStep_Detail1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
