...
''' <summary>
''' The generated superclass for the <see cref="WTask_Delegation1Record"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseWTask_Delegation1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As WTask_Delegation1Table = WTask_Delegation1Table.Instance
    ...
    Public Overridable Sub WTask_Delegation1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim WTask_Delegation1Rec As WTask_Delegation1Record = CType(sender,WTask_Delegation1Record)
        Validate_Inserting()
        If Not WTask_Delegation1Rec Is Nothing AndAlso Not WTask_Delegation1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub WTask_Delegation1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub WTask_Delegation1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
