...
' Your customizations should be made in W_Email1Record.vb
...
''' <summary>
''' The generated superclass for the <see cref="W_Email1Record"></see> class.
''' </summary>
''' <remarks>
''' This class is not intended to be instantiated directly.  To obtain an instance of this class, 
''' use the methods of the <see cref="W_Email1Table"></see> class.
''' </remarks>
''' <seealso cref="W_Email1Table"></seealso>
''' <seealso cref="W_Email1Record"></seealso>

<Serializable()> Public Class BaseW_Email1Record
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As W_Email1Table = W_Email1Table.Instance
    ...
    Public Overridable Sub W_Email1Record_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim W_Email1Rec As W_Email1Record = CType(sender,W_Email1Record)
        Validate_Inserting()
        If Not W_Email1Rec Is Nothing AndAlso Not W_Email1Rec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub W_Email1Record_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub W_Email1Record_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
