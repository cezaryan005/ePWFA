...
''' <summary>
''' The generated superclass for the <see cref="W_Email_DefaultRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseW_Email_DefaultRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As W_Email_DefaultTable = W_Email_DefaultTable.Instance
    ...
    Public Overridable Sub W_Email_DefaultRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim W_Email_DefaultRec As W_Email_DefaultRecord = CType(sender,W_Email_DefaultRecord)
        Validate_Inserting()
        If Not W_Email_DefaultRec Is Nothing AndAlso Not W_Email_DefaultRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub W_Email_DefaultRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub W_Email_DefaultRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
