...
''' <summary>
''' The generated superclass for the <see cref="W_UserRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseW_UserRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As W_UserTable = W_UserTable.Instance
    ...
    Public Overridable Sub W_UserRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim W_UserRec As W_UserRecord = CType(sender,W_UserRecord)
        Validate_Inserting()
        If Not W_UserRec Is Nothing AndAlso Not W_UserRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub W_UserRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub W_UserRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
