...
''' <summary>
''' The generated superclass for the <see cref="W_User_DYNAMICS_CompanyRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BaseW_User_DYNAMICS_CompanyRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As W_User_DYNAMICS_CompanyTable = W_User_DYNAMICS_CompanyTable.Instance
    ...
    Public Overridable Sub W_User_DYNAMICS_CompanyRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim W_User_DYNAMICS_CompanyRec As W_User_DYNAMICS_CompanyRecord = CType(sender,W_User_DYNAMICS_CompanyRecord)
        Validate_Inserting()
        If Not W_User_DYNAMICS_CompanyRec Is Nothing AndAlso Not W_User_DYNAMICS_CompanyRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub W_User_DYNAMICS_CompanyRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub W_User_DYNAMICS_CompanyRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
