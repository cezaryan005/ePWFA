...
''' Also provides access to the <see cref="WCAR_ActivityTable"></see> that each record is associated with.
''' </summary>
''' <remarks>
''' </remarks>
''' <seealso cref="WCAR_ActivityTable"></seealso>

<Serializable()> Public Class WCAR_ActivityRecord
	Inherits BaseWCAR_ActivityRecord
	...
	End Sub
        ...
        'Code from ePortal - 04-11-2016 by Ryan --> Start '
