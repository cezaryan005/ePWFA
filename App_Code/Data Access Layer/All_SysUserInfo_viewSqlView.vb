...
''' <summary>
''' Used by the <see cref="All_SysUserInfo_viewView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class All_SysUserInfo_viewSqlView
	Inherits BaseAll_SysUserInfo_viewSqlView
