...
''' <see cref="Sel_Approver_Pending_Tasks2View">ePortalWFApproval.Sel_Approver_Pending_Tasks2View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_Approver_Pending_Tasks2View"></seealso>

Public Class Sel_Approver_Pending_Tasks2Definition

#Region "Definition (XML) for Sel_Approver_Pending_Tasks2Definition table"
	'Next 307 lines contain Table Definition (XML) for table "Sel_Approver_Pending_Tasks2Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_Approver_Pending_Tasks2View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_Approver_Pending_Tasks2</FolderName>")
         tbf.Append(  "<MenuName>Approver Pending Tasks1</MenuName>")
         tbf.Append(  "<QSPath>../sel_Approver_Pending_Tasks2/Sel-Approver-Pending-Tasks-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_Approver_Pending_Tasks2</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_Approver_Pending_Tasks2</TableStoredProcPrefix>")
