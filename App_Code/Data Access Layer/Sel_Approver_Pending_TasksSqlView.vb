...
''' <summary>
''' Used by the <see cref="Sel_Approver_Pending_TasksView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_Approver_Pending_TasksSqlView
	Inherits BaseSel_Approver_Pending_TasksSqlView
