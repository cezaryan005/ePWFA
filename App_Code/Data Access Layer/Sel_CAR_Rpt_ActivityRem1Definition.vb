...
''' <see cref="Sel_CAR_Rpt_ActivityRem1View">ePortalWFApproval.Sel_CAR_Rpt_ActivityRem1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_CAR_Rpt_ActivityRem1View"></seealso>

Public Class Sel_CAR_Rpt_ActivityRem1Definition

#Region "Definition (XML) for Sel_CAR_Rpt_ActivityRem1Definition table"
	'Next 124 lines contain Table Definition (XML) for table "Sel_CAR_Rpt_ActivityRem1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_CAR_Rpt_ActivityRem1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>sel_CAR_Rpt_ActivityRem</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>sel_CAR_Rpt_ActivityRem_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>sel_CAR_Rpt_ActivityRem1</FolderName>")
         tbf.Append(  "<MenuName>CAR Report Activity REM1</MenuName>")
         tbf.Append(  "<QSPath>../sel_CAR_Rpt_ActivityRem1/Sel-CAR-Rpt-ActivityRem-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_CAR_Rpt_ActivityRem1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_CAR_Rpt_ActivityRem1</TableStoredProcPrefix>")
