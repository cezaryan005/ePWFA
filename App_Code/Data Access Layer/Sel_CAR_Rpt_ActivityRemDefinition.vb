...
''' <see cref="Sel_CAR_Rpt_ActivityRemView">ePortalWFApproval.Sel_CAR_Rpt_ActivityRemView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_CAR_Rpt_ActivityRemView"></seealso>

Public Class Sel_CAR_Rpt_ActivityRemDefinition

#Region "Definition (XML) for Sel_CAR_Rpt_ActivityRemDefinition table"
	'Next 165 lines contain Table Definition (XML) for table "Sel_CAR_Rpt_ActivityRemDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_CAR_Rpt_ActivityRemView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_CAR_Rpt_ActivityRem</FolderName>")
         tbf.Append(  "<MenuName>CAR Report Activity REM</MenuName>")
         tbf.Append(  "<QSPath>../sel_CAR_Rpt_ActivityRem/Sel-CAR-Rpt-ActivityRem-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_CAR_Rpt_ActivityRem</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_CAR_Rpt_ActivityRem</TableStoredProcPrefix>")
