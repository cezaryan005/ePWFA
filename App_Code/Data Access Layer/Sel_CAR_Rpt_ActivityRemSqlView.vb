...
''' <summary>
''' Used by the <see cref="Sel_CAR_Rpt_ActivityRemView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_CAR_Rpt_ActivityRemSqlView
	Inherits BaseSel_CAR_Rpt_ActivityRemSqlView
