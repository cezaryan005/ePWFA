...
''' <summary>
''' Used by the <see cref="Sel_DYNAMICS_Company2View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_DYNAMICS_Company2SqlView
	Inherits BaseSel_DYNAMICS_Company2SqlView
