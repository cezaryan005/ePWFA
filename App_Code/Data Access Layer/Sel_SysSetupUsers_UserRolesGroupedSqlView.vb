...
''' <summary>
''' Used by the <see cref="Sel_SysSetupUsers_UserRolesGroupedView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_SysSetupUsers_UserRolesGroupedSqlView
	Inherits BaseSel_SysSetupUsers_UserRolesGroupedSqlView
