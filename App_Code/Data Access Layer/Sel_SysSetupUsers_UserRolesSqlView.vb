...
''' <summary>
''' Used by the <see cref="Sel_SysSetupUsers_UserRolesView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_SysSetupUsers_UserRolesSqlView
	Inherits BaseSel_SysSetupUsers_UserRolesSqlView
