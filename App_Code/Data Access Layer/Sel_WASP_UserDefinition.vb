...
''' <see cref="Sel_WASP_UserView">ePortalWFApproval.Sel_WASP_UserView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WASP_UserView"></seealso>

Public Class Sel_WASP_UserDefinition

#Region "Definition (XML) for Sel_WASP_UserDefinition table"
	'Next 191 lines contain Table Definition (XML) for table "Sel_WASP_UserDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WASP_UserView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_WASP_User</FolderName>")
         tbf.Append(  "<MenuName>WASP User</MenuName>")
         tbf.Append(  "<QSPath>../sel_WASP_User/Sel-WASP-User-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WASP_User</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WASP_User</TableStoredProcPrefix>")
