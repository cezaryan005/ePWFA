...
''' <see cref="Sel_WASP_WF_ApproverView">ePortalWFApproval.Sel_WASP_WF_ApproverView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WASP_WF_ApproverView"></seealso>

Public Class Sel_WASP_WF_ApproverDefinition

#Region "Definition (XML) for Sel_WASP_WF_ApproverDefinition table"
	'Next 150 lines contain Table Definition (XML) for table "Sel_WASP_WF_ApproverDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WASP_WF_ApproverView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_WASP_WF_Approver</FolderName>")
         tbf.Append(  "<MenuName>WASP Workflow Approver</MenuName>")
         tbf.Append(  "<QSPath>../sel_WASP_WF_Approver/Sel-WASP-WF-Approver-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WASP_WF_Approver</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WASP_WF_Approver</TableStoredProcPrefix>")
