...
''' <summary>
''' Used by the <see cref="Sel_WASP_WF_ApproverView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WASP_WF_ApproverSqlView
	Inherits BaseSel_WASP_WF_ApproverSqlView
