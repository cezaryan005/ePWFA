...
''' <see cref="Sel_WASP_WF_Approver_ALL1View">ePortalWFApproval.Sel_WASP_WF_Approver_ALL1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WASP_WF_Approver_ALL1View"></seealso>

Public Class Sel_WASP_WF_Approver_ALL1Definition

#Region "Definition (XML) for Sel_WASP_WF_Approver_ALL1Definition table"
	'Next 98 lines contain Table Definition (XML) for table "Sel_WASP_WF_Approver_ALL1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WASP_WF_Approver_ALL1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>sel_WASP_WF_Approver_ALL</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>sel_WASP_WF_Approver_ALL_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>sel_WASP_WF_Approver_ALL1</FolderName>")
         tbf.Append(  "<MenuName>WASP Workflow Approver ALL1</MenuName>")
         tbf.Append(  "<QSPath>../sel_WASP_WF_Approver_ALL1/Sel-WASP-WF-Approver-ALL-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WASP_WF_Approver_ALL1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WASP_WF_Approver_ALL1</TableStoredProcPrefix>")
