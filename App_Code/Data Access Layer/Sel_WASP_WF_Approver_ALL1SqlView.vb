...
''' <summary>
''' Used by the <see cref="Sel_WASP_WF_Approver_ALL1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WASP_WF_Approver_ALL1SqlView
	Inherits BaseSel_WASP_WF_Approver_ALL1SqlView
