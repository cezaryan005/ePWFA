...
''' <see cref="Sel_WASP_WF_Approver_ALLView">ePortalWFApproval.Sel_WASP_WF_Approver_ALLView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WASP_WF_Approver_ALLView"></seealso>

Public Class Sel_WASP_WF_Approver_ALLDefinition

#Region "Definition (XML) for Sel_WASP_WF_Approver_ALLDefinition table"
	'Next 150 lines contain Table Definition (XML) for table "Sel_WASP_WF_Approver_ALLDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WASP_WF_Approver_ALLView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_WASP_WF_Approver_ALL</FolderName>")
         tbf.Append(  "<MenuName>WASP Workflow Approver ALL</MenuName>")
         tbf.Append(  "<QSPath>../sel_WASP_WF_Approver_ALL/Sel-WASP-WF-Approver-ALL-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WASP_WF_Approver_ALL</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WASP_WF_Approver_ALL</TableStoredProcPrefix>")
