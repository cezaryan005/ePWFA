...
''' <summary>
''' Used by the <see cref="Sel_WASP_WF_Approver_ALLView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WASP_WF_Approver_ALLSqlView
	Inherits BaseSel_WASP_WF_Approver_ALLSqlView
