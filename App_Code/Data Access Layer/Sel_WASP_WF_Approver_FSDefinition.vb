...
''' <see cref="Sel_WASP_WF_Approver_FSView">ePortalWFApproval.Sel_WASP_WF_Approver_FSView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WASP_WF_Approver_FSView"></seealso>

Public Class Sel_WASP_WF_Approver_FSDefinition

#Region "Definition (XML) for Sel_WASP_WF_Approver_FSDefinition table"
	'Next 150 lines contain Table Definition (XML) for table "Sel_WASP_WF_Approver_FSDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WASP_WF_Approver_FSView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_WASP_WF_Approver_FS</FolderName>")
         tbf.Append(  "<MenuName>WASP Workflow Approver FS</MenuName>")
         tbf.Append(  "<QSPath>../sel_WASP_WF_Approver_FS/Sel-WASP-WF-Approver-FS-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WASP_WF_Approver_FS</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WASP_WF_Approver_FS</TableStoredProcPrefix>")
