...
''' <see cref="Sel_WASP_WF_Approver_PO2View">ePortalWFApproval.Sel_WASP_WF_Approver_PO2View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WASP_WF_Approver_PO2View"></seealso>

Public Class Sel_WASP_WF_Approver_PO2Definition

#Region "Definition (XML) for Sel_WASP_WF_Approver_PO2Definition table"
	'Next 165 lines contain Table Definition (XML) for table "Sel_WASP_WF_Approver_PO2Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WASP_WF_Approver_PO2View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>sel_WASP_WF_Approver_PO</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>sel_WASP_WF_Approver_PO_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>sel_WASP_WF_Approver_PO2</FolderName>")
         tbf.Append(  "<MenuName>WASP Workflow Approver PO1</MenuName>")
         tbf.Append(  "<QSPath>../sel_WASP_WF_Approver_PO2/Sel-WASP-WF-Approver-PO-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WASP_WF_Approver_PO2</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WASP_WF_Approver_PO2</TableStoredProcPrefix>")
