...
''' <see cref="Sel_WASP_WF_Approver_POView">ePortalWFApproval.Sel_WASP_WF_Approver_POView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WASP_WF_Approver_POView"></seealso>

Public Class Sel_WASP_WF_Approver_PODefinition

#Region "Definition (XML) for Sel_WASP_WF_Approver_PODefinition table"
	'Next 150 lines contain Table Definition (XML) for table "Sel_WASP_WF_Approver_PODefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WASP_WF_Approver_POView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_WASP_WF_Approver_PO</FolderName>")
         tbf.Append(  "<MenuName>WASP Workflow Approver PO</MenuName>")
         tbf.Append(  "<QSPath>../sel_WASP_WF_Approver_PO/Sel-WASP-WF-Approver-PO-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WASP_WF_Approver_PO</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WASP_WF_Approver_PO</TableStoredProcPrefix>")
