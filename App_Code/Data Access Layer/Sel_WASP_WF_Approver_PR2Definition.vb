...
''' <see cref="Sel_WASP_WF_Approver_PR2View">ePortalWFApproval.Sel_WASP_WF_Approver_PR2View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WASP_WF_Approver_PR2View"></seealso>

Public Class Sel_WASP_WF_Approver_PR2Definition

#Region "Definition (XML) for Sel_WASP_WF_Approver_PR2Definition table"
	'Next 165 lines contain Table Definition (XML) for table "Sel_WASP_WF_Approver_PR2Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WASP_WF_Approver_PR2View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>sel_WASP_WF_Approver_PR</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>sel_WASP_WF_Approver_PR_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>sel_WASP_WF_Approver_PR2</FolderName>")
         tbf.Append(  "<MenuName>WASP Workflow Approver PR1</MenuName>")
         tbf.Append(  "<QSPath>../sel_WASP_WF_Approver_PR2/Sel-WASP-WF-Approver-PR-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WASP_WF_Approver_PR2</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WASP_WF_Approver_PR2</TableStoredProcPrefix>")
