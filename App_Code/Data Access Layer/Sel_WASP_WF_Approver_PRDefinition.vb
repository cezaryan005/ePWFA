...
''' <see cref="Sel_WASP_WF_Approver_PRView">ePortalWFApproval.Sel_WASP_WF_Approver_PRView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WASP_WF_Approver_PRView"></seealso>

Public Class Sel_WASP_WF_Approver_PRDefinition

#Region "Definition (XML) for Sel_WASP_WF_Approver_PRDefinition table"
	'Next 150 lines contain Table Definition (XML) for table "Sel_WASP_WF_Approver_PRDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WASP_WF_Approver_PRView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_WASP_WF_Approver_PR</FolderName>")
         tbf.Append(  "<MenuName>WASP Workflow Approver PR</MenuName>")
         tbf.Append(  "<QSPath>../sel_WASP_WF_Approver_PR/Sel-WASP-WF-Approver-PR-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WASP_WF_Approver_PR</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WASP_WF_Approver_PR</TableStoredProcPrefix>")
