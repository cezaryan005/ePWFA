...
''' <summary>
''' Used by the <see cref="Sel_WASP_WF_Approver_PRView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WASP_WF_Approver_PRSqlView
	Inherits BaseSel_WASP_WF_Approver_PRSqlView
