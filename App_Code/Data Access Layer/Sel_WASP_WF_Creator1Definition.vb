...
''' <see cref="Sel_WASP_WF_Creator1View">ePortalWFApproval.Sel_WASP_WF_Creator1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WASP_WF_Creator1View"></seealso>

Public Class Sel_WASP_WF_Creator1Definition

#Region "Definition (XML) for Sel_WASP_WF_Creator1Definition table"
	'Next 165 lines contain Table Definition (XML) for table "Sel_WASP_WF_Creator1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WASP_WF_Creator1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>sel_WASP_WF_Creator</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>sel_WASP_WF_Creator_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>sel_WASP_WF_Creator1</FolderName>")
         tbf.Append(  "<MenuName>WASP Workflow Creator1</MenuName>")
         tbf.Append(  "<QSPath>../sel_WASP_WF_Creator1/Sel-WASP-WF-Creator-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WASP_WF_Creator1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WASP_WF_Creator1</TableStoredProcPrefix>")
