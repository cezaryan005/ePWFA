...
''' <see cref="Sel_WASP_WF_CreatorView">ePortalWFApproval.Sel_WASP_WF_CreatorView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WASP_WF_CreatorView"></seealso>

Public Class Sel_WASP_WF_CreatorDefinition

#Region "Definition (XML) for Sel_WASP_WF_CreatorDefinition table"
	'Next 150 lines contain Table Definition (XML) for table "Sel_WASP_WF_CreatorDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WASP_WF_CreatorView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_WASP_WF_Creator</FolderName>")
         tbf.Append(  "<MenuName>WASP Workflow Creator</MenuName>")
         tbf.Append(  "<QSPath>../sel_WASP_WF_Creator/Sel-WASP-WF-Creator-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WASP_WF_Creator</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WASP_WF_Creator</TableStoredProcPrefix>")
