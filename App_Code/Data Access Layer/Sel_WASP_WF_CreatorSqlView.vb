...
''' <summary>
''' Used by the <see cref="Sel_WASP_WF_CreatorView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WASP_WF_CreatorSqlView
	Inherits BaseSel_WASP_WF_CreatorSqlView
