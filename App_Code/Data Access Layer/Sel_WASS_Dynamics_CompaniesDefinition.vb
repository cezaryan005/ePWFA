...
''' <see cref="Sel_WASS_Dynamics_CompaniesView">ePortalWFApproval.Sel_WASS_Dynamics_CompaniesView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WASS_Dynamics_CompaniesView"></seealso>

Public Class Sel_WASS_Dynamics_CompaniesDefinition

#Region "Definition (XML) for Sel_WASS_Dynamics_CompaniesDefinition table"
	'Next 124 lines contain Table Definition (XML) for table "Sel_WASS_Dynamics_CompaniesDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WASS_Dynamics_CompaniesView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_WASS_Dynamics_Companies</FolderName>")
         tbf.Append(  "<MenuName>WASS Dynamics Companies</MenuName>")
         tbf.Append(  "<QSPath>../sel_WASS_Dynamics_Companies/Sel-WASS-Dynamics-Companies-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WASS_Dynamics_Companies</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WASS_Dynamics_Companies</TableStoredProcPrefix>")
