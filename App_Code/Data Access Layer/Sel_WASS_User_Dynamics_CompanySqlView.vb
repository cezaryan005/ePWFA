...
''' <summary>
''' Used by the <see cref="Sel_WASS_User_Dynamics_CompanyView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WASS_User_Dynamics_CompanySqlView
	Inherits BaseSel_WASS_User_Dynamics_CompanySqlView
