...
''' <summary>
''' Used by the <see cref="Sel_WAttach_Type_WCAR_Doc_AttachView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WAttach_Type_WCAR_Doc_AttachSqlView
	Inherits BaseSel_WAttach_Type_WCAR_Doc_AttachSqlView
