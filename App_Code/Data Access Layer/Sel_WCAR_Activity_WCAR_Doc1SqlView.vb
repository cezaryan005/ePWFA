...
''' <summary>
''' Used by the <see cref="Sel_WCAR_Activity_WCAR_Doc1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WCAR_Activity_WCAR_Doc1SqlView
	Inherits BaseSel_WCAR_Activity_WCAR_Doc1SqlView
