...
''' <see cref="Sel_WCAR_Activity_WCAR_DocView">ePortalWFApproval.Sel_WCAR_Activity_WCAR_DocView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WCAR_Activity_WCAR_DocView"></seealso>

Public Class Sel_WCAR_Activity_WCAR_DocDefinition

#Region "Definition (XML) for Sel_WCAR_Activity_WCAR_DocDefinition table"
	'Next 669 lines contain Table Definition (XML) for table "Sel_WCAR_Activity_WCAR_DocDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WCAR_Activity_WCAR_DocView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKColumnDisplay>= WDoc_Type.WDT_Name</columnFKColumnDisplay>")
         ...
         tbf.Append(      "<columnUIName Source=""User"">WCA WCD</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<updatingFormula></updatingFormula>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>VFK_sel_WCAR_Activity_WCAR_Doc_WCA_WCD_ID_1</columnFKName>")
         ...
         tbf.Append(        "<columnFKColumnDisplay>= WCAR_Doc.WCD_No</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         ...
         tbf.Append(        "<columnFKColumnDisplay>= WCurrency.WCur_Desc</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Implicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(    "</Column>")
         ...
         tbf.Append(  "<FolderName>sel_WCAR_Activity_WCAR_Doc</FolderName>")
         tbf.Append(  "<MenuName>WCAR Activity WCAR Document</MenuName>")
         tbf.Append(  "<QSPath>../sel_WCAR_Activity_WCAR_Doc/Sel-WCAR-Activity-WCAR-Doc-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WCAR_Activity_WCAR_Doc</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WCAR_Activity_WCAR_Doc</TableStoredProcPrefix>")
