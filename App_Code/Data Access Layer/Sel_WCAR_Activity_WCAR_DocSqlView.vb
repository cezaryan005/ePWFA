...
''' <summary>
''' Used by the <see cref="Sel_WCAR_Activity_WCAR_DocView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WCAR_Activity_WCAR_DocSqlView
	Inherits BaseSel_WCAR_Activity_WCAR_DocSqlView
