...
''' <summary>
''' Used by the <see cref="Sel_WCAR_Doc_Creator_Approver1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WCAR_Doc_Creator_Approver1SqlView
	Inherits BaseSel_WCAR_Doc_Creator_Approver1SqlView
