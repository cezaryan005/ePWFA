...
''' <summary>
''' Used by the <see cref="Sel_WCAR_Doc_Creator_ApproverView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WCAR_Doc_Creator_ApproverSqlView
	Inherits BaseSel_WCAR_Doc_Creator_ApproverSqlView
