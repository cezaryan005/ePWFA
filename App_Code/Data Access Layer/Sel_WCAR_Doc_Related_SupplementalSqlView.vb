...
''' <summary>
''' Used by the <see cref="Sel_WCAR_Doc_Related_SupplementalView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WCAR_Doc_Related_SupplementalSqlView
	Inherits BaseSel_WCAR_Doc_Related_SupplementalSqlView
