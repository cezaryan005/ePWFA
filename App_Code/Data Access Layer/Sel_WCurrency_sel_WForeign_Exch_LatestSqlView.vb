...
''' <summary>
''' Used by the <see cref="Sel_WCurrency_sel_WForeign_Exch_LatestView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WCurrency_sel_WForeign_Exch_LatestSqlView
	Inherits BaseSel_WCurrency_sel_WForeign_Exch_LatestSqlView
