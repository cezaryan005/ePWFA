...
''' <see cref="Sel_WF_DYNAMICS_Company1View">ePortalWFApproval.Sel_WF_DYNAMICS_Company1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_WF_DYNAMICS_Company1View"></seealso>

Public Class Sel_WF_DYNAMICS_Company1Definition

#Region "Definition (XML) for Sel_WF_DYNAMICS_Company1Definition table"
	'Next 165 lines contain Table Definition (XML) for table "Sel_WF_DYNAMICS_Company1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_WF_DYNAMICS_Company1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>sel_WF_DYNAMICS_Company</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>sel_WF_DYNAMICS_Company_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>sel_WF_DYNAMICS_Company1</FolderName>")
         tbf.Append(  "<MenuName>Workflow DYNAMICS Company1</MenuName>")
         tbf.Append(  "<QSPath>../sel_WF_DYNAMICS_Company1/Sel-WF-DYNAMICS-Company-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_WF_DYNAMICS_Company1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_WF_DYNAMICS_Company1</TableStoredProcPrefix>")
