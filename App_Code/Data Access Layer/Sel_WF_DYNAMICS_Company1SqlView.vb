...
''' <summary>
''' Used by the <see cref="Sel_WF_DYNAMICS_Company1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WF_DYNAMICS_Company1SqlView
	Inherits BaseSel_WF_DYNAMICS_Company1SqlView
