...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="Sel_WF_DYNAMICS_CompanyView"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Sel_WF_DYNAMICS_CompanySqlView
		Inherits BaseSel_WF_DYNAMICS_CompanySqlView
