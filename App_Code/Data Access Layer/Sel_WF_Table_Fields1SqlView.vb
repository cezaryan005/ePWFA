...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="Sel_WF_Table_Fields1View"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Sel_WF_Table_Fields1SqlView
		Inherits BaseSel_WF_Table_Fields1SqlView
