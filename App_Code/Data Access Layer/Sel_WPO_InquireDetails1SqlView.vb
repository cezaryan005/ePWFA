...
''' <summary>
''' Used by the <see cref="Sel_WPO_InquireDetails1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WPO_InquireDetails1SqlView
	Inherits BaseSel_WPO_InquireDetails1SqlView
