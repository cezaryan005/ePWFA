...
''' <summary>
''' Used by the <see cref="Sel_WPO_InquireDetailsView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WPO_InquireDetailsSqlView
	Inherits BaseSel_WPO_InquireDetailsSqlView
