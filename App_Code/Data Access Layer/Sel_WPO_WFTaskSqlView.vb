...
''' <summary>
''' Used by the <see cref="Sel_WPO_WFTaskView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WPO_WFTaskSqlView
	Inherits BaseSel_WPO_WFTaskSqlView
