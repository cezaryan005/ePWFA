...
''' <summary>
''' Used by the <see cref="Sel_WStep_WStep_Detail1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WStep_WStep_Detail1SqlView
	Inherits BaseSel_WStep_WStep_Detail1SqlView
