...
''' <summary>
''' Used by the <see cref="Sel_WStep_WStep_DetailView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class Sel_WStep_WStep_DetailSqlView
	Inherits BaseSel_WStep_WStep_DetailSqlView
