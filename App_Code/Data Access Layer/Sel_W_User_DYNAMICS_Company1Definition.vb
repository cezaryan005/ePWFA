...
''' <see cref="Sel_W_User_DYNAMICS_Company1View">ePortalWFApproval.Sel_W_User_DYNAMICS_Company1View</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_W_User_DYNAMICS_Company1View"></seealso>

Public Class Sel_W_User_DYNAMICS_Company1Definition

#Region "Definition (XML) for Sel_W_User_DYNAMICS_Company1Definition table"
	'Next 150 lines contain Table Definition (XML) for table "Sel_W_User_DYNAMICS_Company1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_W_User_DYNAMICS_Company1View"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>sel_W_User_DYNAMICS_Company</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>sel_W_User_DYNAMICS_Company_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>sel_W_User_DYNAMICS_Company1</FolderName>")
         tbf.Append(  "<MenuName>W User DYNAMICS Company2</MenuName>")
         tbf.Append(  "<QSPath>../sel_W_User_DYNAMICS_Company1/Sel-W-User-DYNAMICS-Company-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_W_User_DYNAMICS_Company1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_W_User_DYNAMICS_Company1</TableStoredProcPrefix>")
