...
''' <see cref="Sel_W_User_DYNAMICS_CompanyView">ePortalWFApproval.Sel_W_User_DYNAMICS_CompanyView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Sel_W_User_DYNAMICS_CompanyView"></seealso>

Public Class Sel_W_User_DYNAMICS_CompanyDefinition

#Region "Definition (XML) for Sel_W_User_DYNAMICS_CompanyDefinition table"
	'Next 150 lines contain Table Definition (XML) for table "Sel_W_User_DYNAMICS_CompanyDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Sel_W_User_DYNAMICS_CompanyView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>sel_W_User_DYNAMICS_Company</FolderName>")
         tbf.Append(  "<MenuName>W User DYNAMICS Company1</MenuName>")
         tbf.Append(  "<QSPath>../sel_W_User_DYNAMICS_Company/Sel-W-User-DYNAMICS-Company-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>Sel_W_User_DYNAMICS_Company</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalSel_W_User_DYNAMICS_Company</TableStoredProcPrefix>")
