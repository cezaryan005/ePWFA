...
Namespace ePortalWFApproval.Data
    ...
    Public Class BaseFormulaEvaluator
        ...
        Public Sub New(Optional ByVal mainObj As Object = Nothing)
            ...
            Evaluator.Imports.AddType(GetType(BaseFormulaUtilsGEN))
                    ...
                    If globalWhereClauseFormula.ToLower().Contains("userid()") Or globalWhereClauseFormula.ToLower().Contains("username()") Or _
                       globalWhereClauseFormula.ToLower().Contains("roles()") Then
                        ...
                        If (System.Web.HttpContext.Current.Request.Url.AbsolutePath.ToLower().Contains(BaseClasses.Configuration.ApplicationSettings.Current.SendUserInfoEmailUrl.ToString().ToLower())) Then
                            Return False
                        End If
                        If (System.Web.HttpContext.Current.Request.Url.AbsolutePath.ToLower().Contains(BaseClasses.Configuration.ApplicationSettings.Current.MobileSignInPageUrl.ToString().ToLower())) Then
                            Return False
                        End If
                        If (System.Web.HttpContext.Current.Request.Url.AbsolutePath.ToLower().Contains(BaseClasses.Configuration.ApplicationSettings.Current.MobileSignedOutPageUrl.ToString().ToLower())) Then
                            Return False
                        End If
                        If (System.Web.HttpContext.Current.Request.Url.AbsolutePath.ToLower().Contains(BaseClasses.Configuration.ApplicationSettings.Current.MobileForgotUserPageUrl.ToString().ToLower())) Then
                            Return False
                        End If
                    End If
                End If
