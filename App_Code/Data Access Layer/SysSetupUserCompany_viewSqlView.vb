...
''' <summary>
''' Used by the <see cref="SysSetupUserCompany_viewView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class SysSetupUserCompany_viewSqlView
	Inherits BaseSysSetupUserCompany_viewSqlView
