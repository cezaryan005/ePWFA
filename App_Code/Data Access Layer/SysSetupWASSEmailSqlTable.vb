...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="SysSetupWASSEmailTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class SysSetupWASSEmailSqlTable
		Inherits BaseSysSetupWASSEmailSqlTable
