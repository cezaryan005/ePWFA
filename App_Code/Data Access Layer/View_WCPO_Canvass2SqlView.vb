...
''' <summary>
''' Used by the <see cref="View_WCPO_Canvass2View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class View_WCPO_Canvass2SqlView
	Inherits BaseView_WCPO_Canvass2SqlView
