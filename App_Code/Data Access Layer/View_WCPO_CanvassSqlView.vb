...
''' <summary>
''' Used by the <see cref="View_WCPO_CanvassView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class View_WCPO_CanvassSqlView
	Inherits BaseView_WCPO_CanvassSqlView
