...
''' <see cref="WASS_Dynamics_Comp_Eq1Table">ePortalWFApproval.WASS_Dynamics_Comp_Eq1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WASS_Dynamics_Comp_Eq1Table"></seealso>

Public Class WASS_Dynamics_Comp_Eq1Definition

#Region "Definition (XML) for WASS_Dynamics_Comp_Eq1Definition table"
	'Next 125 lines contain Table Definition (XML) for table "WASS_Dynamics_Comp_Eq1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WASS_Dynamics_Comp_Eq1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>WDCE_ID</columnName>")
         tbf.Append(      "<columnUIName>Wdce</columnUIName>")
         ...
         tbf.Append(      "<columnName>WDCE_WASS_CompID</columnName>")
         tbf.Append(      "<columnUIName>WDCE WASS Company</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>WDCE_Dynamics_CompID</columnName>")
         tbf.Append(      "<columnUIName>WDCE Dynamics Company</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>WDCE_CompName</columnName>")
         tbf.Append(      "<columnUIName>WDCE Company Name</columnUIName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WASS_Dynamics_Comp_Eq</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WASS_Dynamics_Comp_Eq_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WASS_Dynamics_Comp_Eq1</FolderName>")
         tbf.Append(  "<MenuName>WASS Dynamics Company EQ1</MenuName>")
         tbf.Append(  "<QSPath>../WASS_Dynamics_Comp_Eq1/WASS-Dynamics-Comp-Eq-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WASS_Dynamics_Comp_Eq1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWASS_Dynamics_Comp_Eq1</TableStoredProcPrefix>")
