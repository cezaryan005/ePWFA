...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WASS_Dynamics_Comp_Eq1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WASS_Dynamics_Comp_Eq1SqlTable
		Inherits BaseWASS_Dynamics_Comp_Eq1SqlTable
