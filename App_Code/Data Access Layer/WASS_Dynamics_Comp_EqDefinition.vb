...
''' <see cref="WASS_Dynamics_Comp_EqTable">ePortalWFApproval.WASS_Dynamics_Comp_EqTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WASS_Dynamics_Comp_EqTable"></seealso>

Public Class WASS_Dynamics_Comp_EqDefinition

#Region "Definition (XML) for WASS_Dynamics_Comp_EqDefinition table"
	'Next 125 lines contain Table Definition (XML) for table "WASS_Dynamics_Comp_EqDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WASS_Dynamics_Comp_EqTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WASS_Dynamics_Comp_Eq</FolderName>")
         tbf.Append(  "<MenuName>WASS Dynamics Company EQ</MenuName>")
         tbf.Append(  "<QSPath>../WASS_Dynamics_Comp_Eq/WASS-Dynamics-Comp-Eq-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WASS_Dynamics_Comp_Eq</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWASS_Dynamics_Comp_Eq</TableStoredProcPrefix>")
