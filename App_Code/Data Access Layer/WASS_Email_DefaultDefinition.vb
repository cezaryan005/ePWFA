...
''' <see cref="WASS_Email_DefaultTable">ePortalWFApproval.WASS_Email_DefaultTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WASS_Email_DefaultTable"></seealso>

Public Class WASS_Email_DefaultDefinition

#Region "Definition (XML) for WASS_Email_DefaultDefinition table"
	'Next 99 lines contain Table Definition (XML) for table "WASS_Email_DefaultDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WASS_Email_DefaultTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WASS_Email_Default</FolderName>")
         tbf.Append(  "<MenuName>WASS Email Default</MenuName>")
         tbf.Append(  "<QSPath>../WASS_Email_Default/WASS-Email-Default-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WASS_Email_Default</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWASS_Email_Default</TableStoredProcPrefix>")
