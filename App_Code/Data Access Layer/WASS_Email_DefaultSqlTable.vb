...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WASS_Email_DefaultTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WASS_Email_DefaultSqlTable
		Inherits BaseWASS_Email_DefaultSqlTable
