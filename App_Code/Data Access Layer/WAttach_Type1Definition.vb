...
''' <see cref="WAttach_Type1Table">ePortalWFApproval.WAttach_Type1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WAttach_Type1Table"></seealso>

Public Class WAttach_Type1Definition

#Region "Definition (XML) for WAttach_Type1Definition table"
	'Next 125 lines contain Table Definition (XML) for table "WAttach_Type1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WAttach_Type1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WAttach_Type1</FolderName>")
         tbf.Append(  "<MenuName>WAttach Type1</MenuName>")
         tbf.Append(  "<QSPath>../WAttach_Type1/WAttach-Type-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WAttach_Type1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWAttach_Type1</TableStoredProcPrefix>")
