...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WAttach_Type1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WAttach_Type1SqlTable
		Inherits BaseWAttach_Type1SqlTable
