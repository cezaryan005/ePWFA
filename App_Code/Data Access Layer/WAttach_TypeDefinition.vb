...
''' <see cref="WAttach_TypeTable">ePortalWFApproval.WAttach_TypeTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WAttach_TypeTable"></seealso>

Public Class WAttach_TypeDefinition

#Region "Definition (XML) for WAttach_TypeDefinition table"
	'Next 125 lines contain Table Definition (XML) for table "WAttach_TypeDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WAttach_TypeTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>WAT_Operation</columnName>")
         tbf.Append(      "<columnUIName>WAT Operation</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WAttach_Type</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WAttach_Type_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WAttach_Type</FolderName>")
         tbf.Append(  "<MenuName>WAttach Type</MenuName>")
         tbf.Append(  "<QSPath>../WAttach_Type/WAttach-Type-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WAttach_Type</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWAttach_Type</TableStoredProcPrefix>")
