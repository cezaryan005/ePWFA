...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WAttach_TypeTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WAttach_TypeSqlTable
		Inherits BaseWAttach_TypeSqlTable
