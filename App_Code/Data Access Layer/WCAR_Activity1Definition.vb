...
''' <see cref="WCAR_Activity1Table">ePortalWFApproval.WCAR_Activity1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WCAR_Activity1Table"></seealso>

Public Class WCAR_Activity1Definition

#Region "Definition (XML) for WCAR_Activity1Definition table"
	'Next 415 lines contain Table Definition (XML) for table "WCAR_Activity1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WCAR_Activity1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WCAR_Activity1</FolderName>")
         tbf.Append(  "<MenuName>WCAR Activity2</MenuName>")
         tbf.Append(  "<QSPath>../WCAR_Activity1/WCAR-Activity-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WCAR_Activity1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWCAR_Activity1</TableStoredProcPrefix>")
