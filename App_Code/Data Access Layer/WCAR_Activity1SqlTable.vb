...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WCAR_Activity1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WCAR_Activity1SqlTable
		Inherits BaseWCAR_Activity1SqlTable
