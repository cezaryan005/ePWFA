...
''' <see cref="WCAR_DocTable">ePortalWFApproval.WCAR_DocTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WCAR_DocTable"></seealso>

Public Class WCAR_DocDefinition

#Region "Definition (XML) for WCAR_DocDefinition table"
	'Next 735 lines contain Table Definition (XML) for table "WCAR_DocDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WCAR_DocTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WCAR_Doc</FolderName>")
         tbf.Append(  "<MenuName>WCAR Document</MenuName>")
         tbf.Append(  "<QSPath>../WCAR_Doc/WCAR-Doc-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WCAR_Doc</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWCAR_Doc</TableStoredProcPrefix>")
