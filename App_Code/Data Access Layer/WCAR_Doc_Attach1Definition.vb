...
''' <see cref="WCAR_Doc_Attach1Table">ePortalWFApproval.WCAR_Doc_Attach1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WCAR_Doc_Attach1Table"></seealso>

Public Class WCAR_Doc_Attach1Definition

#Region "Definition (XML) for WCAR_Doc_Attach1Definition table"
	'Next 169 lines contain Table Definition (XML) for table "WCAR_Doc_Attach1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WCAR_Doc_Attach1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WCAR_Doc_Attach1</FolderName>")
         tbf.Append(  "<MenuName>WCAR Document Attach1</MenuName>")
         tbf.Append(  "<QSPath>../WCAR_Doc_Attach1/WCAR-Doc-Attach-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WCAR_Doc_Attach1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWCAR_Doc_Attach1</TableStoredProcPrefix>")
