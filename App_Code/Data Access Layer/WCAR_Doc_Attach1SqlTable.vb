...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WCAR_Doc_Attach1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WCAR_Doc_Attach1SqlTable
		Inherits BaseWCAR_Doc_Attach1SqlTable
