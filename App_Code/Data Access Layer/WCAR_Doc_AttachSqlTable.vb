...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WCAR_Doc_AttachTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WCAR_Doc_AttachSqlTable
		Inherits BaseWCAR_Doc_AttachSqlTable
