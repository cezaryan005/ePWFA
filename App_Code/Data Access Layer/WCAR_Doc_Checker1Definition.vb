...
''' <see cref="WCAR_Doc_Checker1Table">ePortalWFApproval.WCAR_Doc_Checker1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WCAR_Doc_Checker1Table"></seealso>

Public Class WCAR_Doc_Checker1Definition

#Region "Definition (XML) for WCAR_Doc_Checker1Definition table"
	'Next 182 lines contain Table Definition (XML) for table "WCAR_Doc_Checker1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WCAR_Doc_Checker1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WCAR_Doc_Checker1</FolderName>")
         tbf.Append(  "<MenuName>WCAR Document Checker1</MenuName>")
         tbf.Append(  "<QSPath>../WCAR_Doc_Checker1/WCAR-Doc-Checker-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WCAR_Doc_Checker1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWCAR_Doc_Checker1</TableStoredProcPrefix>")
