...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WCAR_Doc_Checker1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WCAR_Doc_Checker1SqlTable
		Inherits BaseWCAR_Doc_Checker1SqlTable
