...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WCAR_Doc_CheckerTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WCAR_Doc_CheckerSqlTable
		Inherits BaseWCAR_Doc_CheckerSqlTable
