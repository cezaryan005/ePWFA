...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WCanvass_PO_Map_TempTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WCanvass_PO_Map_TempSqlTable
		Inherits BaseWCanvass_PO_Map_TempSqlTable
