...
''' <see cref="WClassificationTable">ePortalWFApproval.WClassificationTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WClassificationTable"></seealso>

Public Class WClassificationDefinition

#Region "Definition (XML) for WClassificationDefinition table"
	'Next 108 lines contain Table Definition (XML) for table "WClassificationDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WClassificationTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKName>FK_WClassification_WClassification</columnFKName>")
         ...
         tbf.Append(  "<FolderName>WClassification</FolderName>")
         tbf.Append(  "<MenuName>W Classification</MenuName>")
         tbf.Append(  "<QSPath>../WClassification/WClassification-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WClassification</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWClassification</TableStoredProcPrefix>")
