...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WClassificationTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WClassificationSqlTable
		Inherits BaseWClassificationSqlTable
