...
''' <see cref="WCurrencyTable">ePortalWFApproval.WCurrencyTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WCurrencyTable"></seealso>

Public Class WCurrencyDefinition

#Region "Definition (XML) for WCurrencyDefinition table"
	'Next 99 lines contain Table Definition (XML) for table "WCurrencyDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WCurrencyTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WCurrency</FolderName>")
         tbf.Append(  "<MenuName>W Currency</MenuName>")
         tbf.Append(  "<QSPath>../WCurrency/WCurrency-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WCurrency</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWCurrency</TableStoredProcPrefix>")
