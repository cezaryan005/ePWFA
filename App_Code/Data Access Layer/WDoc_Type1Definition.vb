...
''' <see cref="WDoc_Type1Table">ePortalWFApproval.WDoc_Type1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WDoc_Type1Table"></seealso>

Public Class WDoc_Type1Definition

#Region "Definition (XML) for WDoc_Type1Definition table"
	'Next 225 lines contain Table Definition (XML) for table "WDoc_Type1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WDoc_Type1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WDoc_Type1</FolderName>")
         tbf.Append(  "<MenuName>WDoc Type1</MenuName>")
         tbf.Append(  "<QSPath>../WDoc_Type1/WDoc-Type-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WDoc_Type1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWDoc_Type1</TableStoredProcPrefix>")
