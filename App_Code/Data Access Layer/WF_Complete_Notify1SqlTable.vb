...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WF_Complete_Notify1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WF_Complete_Notify1SqlTable
		Inherits BaseWF_Complete_Notify1SqlTable
