...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WF_Complete_NotifyTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WF_Complete_NotifySqlTable
		Inherits BaseWF_Complete_NotifySqlTable
