...
''' <see cref="WPO_ActivityTable">ePortalWFApproval.WPO_ActivityTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPO_ActivityTable"></seealso>

Public Class WPO_ActivityDefinition

#Region "Definition (XML) for WPO_ActivityDefinition table"
	'Next 436 lines contain Table Definition (XML) for table "WPO_ActivityDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPO_ActivityTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKColumnDisplay>= WPO_Doc_Type.WPO_DT_Desc</columnFKColumnDisplay>")
         ...
         tbf.Append(  "<FolderName>WPO_Activity</FolderName>")
         tbf.Append(  "<MenuName>WPO Activity</MenuName>")
         tbf.Append(  "<QSPath>../WPO_Activity/WPO-Activity-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPO_Activity</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPO_Activity</TableStoredProcPrefix>")
