...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WPO_ApprovalStatusTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WPO_ApprovalStatusSqlTable
		Inherits BaseWPO_ApprovalStatusSqlTable
