...
''' <summary>
''' Used by the <see cref="WPO_CARNo_QDetails1View"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class WPO_CARNo_QDetails1SqlView
	Inherits BaseWPO_CARNo_QDetails1SqlView
