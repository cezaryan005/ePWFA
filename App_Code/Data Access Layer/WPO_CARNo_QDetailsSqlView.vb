...
''' <summary>
''' Used by the <see cref="WPO_CARNo_QDetailsView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class WPO_CARNo_QDetailsSqlView
	Inherits BaseWPO_CARNo_QDetailsSqlView
