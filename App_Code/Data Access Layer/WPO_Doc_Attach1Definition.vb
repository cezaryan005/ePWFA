...
''' <see cref="WPO_Doc_Attach1Table">ePortalWFApproval.WPO_Doc_Attach1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPO_Doc_Attach1Table"></seealso>

Public Class WPO_Doc_Attach1Definition

#Region "Definition (XML) for WPO_Doc_Attach1Definition table"
	'Next 151 lines contain Table Definition (XML) for table "WPO_Doc_Attach1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPO_Doc_Attach1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>WPODA_PONo</columnName>")
         tbf.Append(      "<columnUIName>WPODA PONo</columnUIName>")
         ...
         tbf.Append(      "<columnName>WPODA_CMPNY</columnName>")
         tbf.Append(      "<columnUIName>Wpoda CMPNY</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>WPO_Doc_Attach</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>WPO_Doc_Attach_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>WPO_Doc_Attach1</FolderName>")
         tbf.Append(  "<MenuName>WPO Document Attach2</MenuName>")
         tbf.Append(  "<QSPath>../WPO_Doc_Attach1/WPO-Doc-Attach-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPO_Doc_Attach1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPO_Doc_Attach1</TableStoredProcPrefix>")
