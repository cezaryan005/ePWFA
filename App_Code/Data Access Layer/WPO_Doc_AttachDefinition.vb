...
''' <see cref="WPO_Doc_AttachTable">ePortalWFApproval.WPO_Doc_AttachTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPO_Doc_AttachTable"></seealso>

Public Class WPO_Doc_AttachDefinition

#Region "Definition (XML) for WPO_Doc_AttachDefinition table"
	'Next 151 lines contain Table Definition (XML) for table "WPO_Doc_AttachDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPO_Doc_AttachTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WPO_Doc_Attach</FolderName>")
         tbf.Append(  "<MenuName>WPO Document Attach1</MenuName>")
         tbf.Append(  "<QSPath>../WPO_Doc_Attach/WPO-Doc-Attach-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPO_Doc_Attach</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPO_Doc_Attach</TableStoredProcPrefix>")
