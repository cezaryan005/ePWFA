...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WPO_Doc_TypeTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WPO_Doc_TypeSqlTable
		Inherits BaseWPO_Doc_TypeSqlTable
