...
''' <summary>
''' Used by the <see cref="WPO_PRNo_QDetailsView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class WPO_PRNo_QDetailsSqlView
	Inherits BaseWPO_PRNo_QDetailsSqlView
