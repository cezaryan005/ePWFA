...
''' <see cref="WPO_Step_WPO_StepDetailView">ePortalWFApproval.WPO_Step_WPO_StepDetailView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WPO_Step_WPO_StepDetailView"></seealso>

Public Class WPO_Step_WPO_StepDetailDefinition

#Region "Definition (XML) for WPO_Step_WPO_StepDetailDefinition table"
	'Next 297 lines contain Table Definition (XML) for table "WPO_Step_WPO_StepDetailDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WPO_Step_WPO_StepDetailView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>WPO_Step_WPO_StepDetail</FolderName>")
         tbf.Append(  "<MenuName>WPO Step WPO Step Detail</MenuName>")
         tbf.Append(  "<QSPath>../WPO_Step_WPO_StepDetail/WPO-Step-WPO-StepDetail-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WPO_Step_WPO_StepDetail</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWPO_Step_WPO_StepDetail</TableStoredProcPrefix>")
