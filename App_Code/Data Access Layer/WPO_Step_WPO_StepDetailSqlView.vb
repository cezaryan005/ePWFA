...
''' <summary>
''' Used by the <see cref="WPO_Step_WPO_StepDetailView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class WPO_Step_WPO_StepDetailSqlView
	Inherits BaseWPO_Step_WPO_StepDetailSqlView
