...
''' <summary>
''' Used by the <see cref="WPO_WFHistory_Details_newView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class WPO_WFHistory_Details_newSqlView
	Inherits BaseWPO_WFHistory_Details_newSqlView
