...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WStep_Detail1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WStep_Detail1SqlTable
		Inherits BaseWStep_Detail1SqlTable
