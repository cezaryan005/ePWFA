...
''' <see cref="WStep_DetailTable">ePortalWFApproval.WStep_DetailTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="WStep_DetailTable"></seealso>

Public Class WStep_DetailDefinition

#Region "Definition (XML) for WStep_DetailDefinition table"
	'Next 290 lines contain Table Definition (XML) for table "WStep_DetailDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="WStep_DetailTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnUIName>WSD W U Delegate</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(  "<FolderName>WStep_Detail</FolderName>")
         tbf.Append(  "<MenuName>WStep Detail</MenuName>")
         tbf.Append(  "<QSPath>../WStep_Detail/WStep-Detail-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>WStep_Detail</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalWStep_Detail</TableStoredProcPrefix>")
