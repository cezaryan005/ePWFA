...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WStep_DetailTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WStep_DetailSqlTable
		Inherits BaseWStep_DetailSqlTable
