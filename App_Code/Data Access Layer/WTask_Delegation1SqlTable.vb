...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="WTask_Delegation1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class WTask_Delegation1SqlTable
		Inherits BaseWTask_Delegation1SqlTable
