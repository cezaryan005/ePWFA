...
''' <see cref="W_Email_Default1Table">ePortalWFApproval.W_Email_Default1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="W_Email_Default1Table"></seealso>

Public Class W_Email_Default1Definition

#Region "Definition (XML) for W_Email_Default1Definition table"
	'Next 99 lines contain Table Definition (XML) for table "W_Email_Default1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="W_Email_Default1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>W_Email_Default</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>W_Email_Default_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>W_Email_Default1</FolderName>")
         tbf.Append(  "<MenuName>W Email Default1</MenuName>")
         tbf.Append(  "<QSPath>../W_Email_Default1/W-Email-Default-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>W_Email_Default1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalW_Email_Default1</TableStoredProcPrefix>")
