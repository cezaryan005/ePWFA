...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="W_Email_Default1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class W_Email_Default1SqlTable
		Inherits BaseW_Email_Default1SqlTable
