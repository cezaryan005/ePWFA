...
''' <see cref="W_Email_DefaultTable">ePortalWFApproval.W_Email_DefaultTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="W_Email_DefaultTable"></seealso>

Public Class W_Email_DefaultDefinition

#Region "Definition (XML) for W_Email_DefaultDefinition table"
	'Next 99 lines contain Table Definition (XML) for table "W_Email_DefaultDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="W_Email_DefaultTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>W_Email_Default</FolderName>")
         tbf.Append(  "<MenuName>W Email Default</MenuName>")
         tbf.Append(  "<QSPath>../W_Email_Default/W-Email-Default-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>W_Email_Default</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalW_Email_Default</TableStoredProcPrefix>")
