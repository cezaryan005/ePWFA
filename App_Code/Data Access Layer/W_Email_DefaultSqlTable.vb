...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="W_Email_DefaultTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class W_Email_DefaultSqlTable
		Inherits BaseW_Email_DefaultSqlTable
