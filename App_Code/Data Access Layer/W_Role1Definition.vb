...
''' <see cref="W_Role1Table">ePortalWFApproval.W_Role1Table</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="W_Role1Table"></seealso>

Public Class W_Role1Definition

#Region "Definition (XML) for W_Role1Definition table"
	'Next 134 lines contain Table Definition (XML) for table "W_Role1Definition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="W_Role1Table"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>W_R_A_ID</columnName>")
         tbf.Append(      "<columnUIName>W R A</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         ...
         tbf.Append(        "<columnFKName>FK_W_Role_W_Application</columnFKName>")
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.W_Application1Table, App_Code</columnFKTable>")
         ...
         tbf.Append(      "<columnName>W_R_Desc</columnName>")
         tbf.Append(      "<columnUIName>W R Description</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>W_Role</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableAliasName>W_Role_</TableAliasName>")
         ...
         tbf.Append(  "<FolderName>W_Role1</FolderName>")
         tbf.Append(  "<MenuName>W Role1</MenuName>")
         tbf.Append(  "<QSPath>../W_Role1/W-Role-QuickSelector1.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>W_Role1</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalW_Role1</TableStoredProcPrefix>")
