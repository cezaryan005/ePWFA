...
''' <see cref="W_RoleTable">ePortalWFApproval.W_RoleTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="W_RoleTable"></seealso>

Public Class W_RoleDefinition

#Region "Definition (XML) for W_RoleDefinition table"
	'Next 134 lines contain Table Definition (XML) for table "W_RoleDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="W_RoleTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>W_Role</FolderName>")
         tbf.Append(  "<MenuName>W Role</MenuName>")
         tbf.Append(  "<QSPath>../W_Role/W-Role-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>W_Role</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalW_Role</TableStoredProcPrefix>")
