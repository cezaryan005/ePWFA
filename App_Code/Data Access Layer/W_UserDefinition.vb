...
''' <see cref="W_UserTable">ePortalWFApproval.W_UserTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="W_UserTable"></seealso>

Public Class W_UserDefinition

#Region "Definition (XML) for W_UserDefinition table"
	'Next 203 lines contain Table Definition (XML) for table "W_UserDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="W_UserTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>W_User</FolderName>")
         tbf.Append(  "<MenuName>W User</MenuName>")
         tbf.Append(  "<QSPath>../W_User/W-User-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>W_User</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalW_User</TableStoredProcPrefix>")
