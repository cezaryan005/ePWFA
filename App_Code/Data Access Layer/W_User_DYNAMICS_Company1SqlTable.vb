...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="W_User_DYNAMICS_Company1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class W_User_DYNAMICS_Company1SqlTable
		Inherits BaseW_User_DYNAMICS_Company1SqlTable
