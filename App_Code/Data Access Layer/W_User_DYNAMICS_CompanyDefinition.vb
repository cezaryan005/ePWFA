...
''' <see cref="W_User_DYNAMICS_CompanyTable">ePortalWFApproval.W_User_DYNAMICS_CompanyTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="W_User_DYNAMICS_CompanyTable"></seealso>

Public Class W_User_DYNAMICS_CompanyDefinition

#Region "Definition (XML) for W_User_DYNAMICS_CompanyDefinition table"
	'Next 99 lines contain Table Definition (XML) for table "W_User_DYNAMICS_CompanyDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="W_User_DYNAMICS_CompanyTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(  "<FolderName>W_User_DYNAMICS_Company</FolderName>")
         tbf.Append(  "<MenuName>W User DYNAMICS Company</MenuName>")
         tbf.Append(  "<QSPath>../W_User_DYNAMICS_Company/W-User-DYNAMICS-Company-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>W_User_DYNAMICS_Company</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalW_User_DYNAMICS_Company</TableStoredProcPrefix>")
