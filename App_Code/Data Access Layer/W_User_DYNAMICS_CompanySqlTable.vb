...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="W_User_DYNAMICS_CompanyTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class W_User_DYNAMICS_CompanySqlTable
		Inherits BaseW_User_DYNAMICS_CompanySqlTable
