...
Namespace ePortalWFApproval.Data
	...
	''' <summary>
	''' Used by the <see cref="W_User_Role1Table"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class W_User_Role1SqlTable
		Inherits BaseW_User_Role1SqlTable
