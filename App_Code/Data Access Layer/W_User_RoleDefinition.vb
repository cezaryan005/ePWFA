...
''' <see cref="W_User_RoleTable">ePortalWFApproval.W_User_RoleTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="W_User_RoleTable"></seealso>

Public Class W_User_RoleDefinition

#Region "Definition (XML) for W_User_RoleDefinition table"
	'Next 117 lines contain Table Definition (XML) for table "W_User_RoleDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="W_User_RoleTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKTable>ePortalWFApproval.Business.W_RoleTable, App_Code</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         ...
         tbf.Append(  "<FolderName>W_User_Role</FolderName>")
         tbf.Append(  "<MenuName>W User Role</MenuName>")
         tbf.Append(  "<QSPath>../W_User_Role/W-User-Role-QuickSelector.aspx</QSPath>")
         tbf.Append(  "<TableCodeName>W_User_Role</TableCodeName>")
         tbf.Append(  "<TableStoredProcPrefix>pePortalWFApprovalW_User_Role</TableStoredProcPrefix>")
