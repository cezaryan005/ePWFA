...
#Region "Section 1: Place your customizations here."
    Public Class BaseApplicationRecordControl
        Inherits BaseApplicationRecordControlGEN
...
#Region "Section 2: Do not modify this section."
    Public Class BaseApplicationRecordControlGEN
...
#End Region
        ...
        Public Overridable Function RowNum() As Decimal
            Return FormulaUtils.RowNum(Me.GetParentTableControl(), DirectCast(Me, BaseApplicationRecordControl))
        End Function
        ...
        Public Overridable Function Rank(ByVal controlName As String) As Decimal
            Return FormulaUtils.Rank(Me.GetParentTableControl(), DirectCast(Me, BaseApplicationRecordControl), controlName)
        End Function
        ...
        Public Overridable Function RunningTotal(ByVal controlName As String) As Decimal
            Return FormulaUtils.RunningTotal(Me.GetParentTableControl(), DirectCast(Me, BaseApplicationRecordControl), controlName)
        End Function
        ...
        Protected _IsNewRecord As Boolean = True
        ...
        Protected Overridable Sub BaseLoad_GEN(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
