...
#Region "Section 1: Place your customizations here."
    Public Class BaseApplicationUserControl
        Inherits BaseApplicationUserControlGEN
...
#Region "Section 2: Do not modify this section."
    ...
    Public Class BaseApplicationUserControlGEN
        ...
        Protected Overridable Sub GetAllRecordAndTableControls(ByVal ctl As Control, ByVal controlList As ArrayList)
            ...
            Next
        End Sub
        Protected Overridable Function GetResourceValue(ByVal keyVal As String, ByVal appName As String) As String
            Try
