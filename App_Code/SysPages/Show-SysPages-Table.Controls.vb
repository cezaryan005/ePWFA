...
' Show_SysPages_Table.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.Show_SysPages_Table

#Region "Section 1: Place your customizations here."

    
Public Class SysPagesTableControlRow
        Inherits BaseSysPagesTableControlRow
        ' The BaseSysPagesTableControlRow implements code for a ROW within the
        ' the SysPagesTableControl table.  The BaseSysPagesTableControlRow implements the DataBind and SaveData methods.
        ' The loading of data is actually performed by the LoadData method in the base class of SysPagesTableControl.
...
Public Class SysPagesTableControl
        Inherits BaseSysPagesTableControl

    ' The BaseSysPagesTableControl class implements the LoadData, DataBind, CreateWhereClause
    ' and other methods to load and display the data in a table control.

    ' This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    ' The SysPagesTableControlRow class offers another place where you can customize
...
' Base class for the SysPagesTableControlRow control on the Show_SysPages_Table page.
' Do not modify this class. Instead override any method in SysPagesTableControlRow.
Public Class BaseSysPagesTableControlRow
        Inherits ePortalWFApproval.UI.BaseApplicationRecordControl

        '  To customize, override this method in SysPagesTableControlRow.
        ...
        Public Overridable Sub LoadData()        
            ...
            ' Load the data from the database into the DataSource DatabaseWASS%dbo.SysPages record.
            ...
            If Me.RecordUniqueId IsNot Nothing AndAlso Me.RecordUniqueId.Trim <> "" Then
                Me.DataSource = SysPagesTable.GetRecord(Me.RecordUniqueId, True)
          
                Return
            End If
        
            ' Since this is a row in the table, the data for this row is loaded by the 
            ' LoadData method of the BaseSysPagesTableControl when the data for the entire
            ' table is loaded.
            
            Me.DataSource = New SysPagesRecord()
          
    
    
        End Sub

        ' Populate the UI controls using the DataSource.  To customize, override this method in SysPagesTableControlRow.
        ...
        Public Overridable Sub SetChecked0()
            ...
            ' DatabaseWASS%dbo.SysPages database record.

            ' Me.DataSource is the DatabaseWASS%dbo.SysPages record retrieved from the database.
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.Checked0Specified Then
                ...
                Dim formattedValue As String = Me.DataSource.Format(SysPagesTable.Checked0)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.Checked0.Text = SysPagesTable.Checked0.Format(SysPagesTable.Checked0.DefaultValue)
        ...
        Public Overridable Sub SetDateCreated()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.DateCreatedSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(SysPagesTable.DateCreated, "g")
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.DateCreated.Text = SysPagesTable.DateCreated.Format(SysPagesTable.DateCreated.DefaultValue, "g")
        ...
        Public Overridable Sub SetisDisplay()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.isDisplaySpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(SysPagesTable.isDisplay)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.isDisplay.Text = SysPagesTable.isDisplay.Format(SysPagesTable.isDisplay.DefaultValue)
        ...
        Public Overridable Sub SetLevel()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.LevelSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(SysPagesTable.Level)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.Level.Text = SysPagesTable.Level.Format(SysPagesTable.Level.DefaultValue)
        ...
        Public Overridable Sub SetPageName()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.PageNameSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(SysPagesTable.PageName)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.PageName.Text = SysPagesTable.PageName.Format(SysPagesTable.PageName.DefaultValue)
        ...
        Public Overridable Sub SetParentID()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.ParentIDSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(SysPagesTable.ParentID)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.ParentID.Text = SysPagesTable.ParentID.Format(SysPagesTable.ParentID.DefaultValue)
        ...
        Public Overridable Sub SetSorting()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.SortingSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(SysPagesTable.Sorting)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.Sorting.Text = SysPagesTable.Sorting.Format(SysPagesTable.Sorting.DefaultValue)
        ...
        Public Overridable Sub SetSystemID()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.SystemIDSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(SysPagesTable.SystemID)
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.SystemID.Text = SysPagesTable.SystemID.Format(SysPagesTable.SystemID.DefaultValue)
        ...
        Public Overridable Sub SetURL()
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.URLSpecified Then
                ...
                ' The Format method will use the Display Format
                Dim formattedValue As String = Me.DataSource.Format(SysPagesTable.URL)
                ...
                If Not formattedValue is Nothing Then
                    ...
                    If originalLength >= popupThreshold Then
                        ...
                        Dim name As String = HttpUtility.HtmlEncode(SysPagesTable.URL.Name)
                        ...
                        formattedValue= "<a onclick='gPersist=true;' class='truncatedText' onmouseout='detailRolloverPopupClose();' " _
                            & "onmouseover='SaveMousePosition(event); delayRolloverPopup(""PageMethods.GetRecordFieldValue(\""ePortalWFApproval.Business.SysPagesTable, App_Code\"",\""" _
            ...
            Else 
                ...
                ' Default Value could also be NULL.
                 ...
                 Me.URL.Text = SysPagesTable.URL.Format(SysPagesTable.URL.DefaultValue)
        ...
        Public Overridable Sub SaveData()
            ...
            If Me.DataSource.IsAnyValueChanged Then
                ...
                DirectCast(GetParentControlObject(Me, "SysPagesTableControl"), SysPagesTableControl).DataChanged = True
                DirectCast(GetParentControlObject(Me, "SysPagesTableControl"), SysPagesTableControl).ResetData = True
            End If
        ...
        Dim hasFiltersSysPagesTableControl As Boolean = False
        ...
        Public Overridable Sub Delete()
          ...
          SysPagesTable.DeleteRecord(pkValue)
    ...
    Try
      ...
      Me.Page.Response.Redirect(url)
        ...
        Public Property RecordUniqueId() As String
            Get
                Return CType(Me.ViewState("BaseSysPagesTableControlRow_Rec"), String)
            End Get
            Set(ByVal value As String)
                Me.ViewState("BaseSysPagesTableControlRow_Rec") = value
            End Set
        End Property
            
        Public Property DataSource() As SysPagesRecord
            Get
                Return DirectCast(MyBase._DataSource, SysPagesRecord)
            End Get
            Set(ByVal value As SysPagesRecord)
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetRecord() As SysPagesRecord
            ...
            If Not Me.RecordUniqueId Is Nothing Then
                ...
                Return SysPagesTable.GetRecord(Me.RecordUniqueId, True)
...
' Base class for the SysPagesTableControl control on the Show_SysPages_Table page.
' Do not modify this class. Instead override any method in SysPagesTableControl.
Public Class BaseSysPagesTableControl
    ...
    ' Setup default pagination settings.
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                If wc IsNot Nothing AndAlso Not wc.RunQuery Then
                    ...
                    Me.DataSource = DirectCast(alist.ToArray(GetType(SysPagesRecord)), SysPagesRecord())
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    ...
                    For Each rc As SysPagesTableControlRow In Me.GetRecordControls()
                        ...
                        End If
                    Next
                    Me.DataSource = DirectCast(postdata.ToArray(GetType(SysPagesRecord)), SysPagesRecord())
        ...
        Public Overridable Function GetRecords( _
            ...
            ' selCols.Add(SysPagesTable.Column1, True)         
            ' selCols.Add(SysPagesTable.Column2, True)          
            ' selCols.Add(SysPagesTable.Column3, True)    
            ...
            If selCols.Count = 0 Then                    
                ...
                Return SysPagesTable.GetRecords(join, where, orderBy, Me.PageIndex, Me.PageSize)
                 
            Else
                Dim databaseTable As New SysPagesTable
                ...
                Return CType(recList.ToArray(GetType(SysPagesRecord)), SysPagesRecord())
            End If            
        ...
        Public Overridable Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
            ...
            If selCols.Count = 0 Then                    
                ...
                Return SysPagesTable.GetRecordCount(join, where)
        ...
        Public Overrides Sub DataBind()
          ...
          Dim rep As System.Web.UI.WebControls.Repeater = CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "SysPagesTableControlRepeater"), System.Web.UI.WebControls.Repeater)
          ...
          For Each repItem As System.Web.UI.WebControls.RepeaterItem In rep.Items
            ...
            Dim recControl As SysPagesTableControlRow = DirectCast(repItem.FindControl("SysPagesTableControlRow"), SysPagesTableControlRow)
    ...
    End Sub
        ...
        Protected Overridable Sub BindPaginationControls()
            ...
            ' Bind the buttons for SysPagesTableControl pagination.
        ...
        Public Overridable Sub SaveData()
            ...
            Dim recCtl As SysPagesTableControlRow
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            SysPagesTable.Instance.InnerFilter = Nothing
        ...
        Dim hasFiltersSysPagesTableControl As Boolean = False
            ...
            If IsValueSelected(Me.PageNameFilter) Then
              ...
              hasFiltersSysPagesTableControl = True            
                ...
                For Each item In Me.PageNameFilter.Items
                    ...
                    End If
                    If item.Selected Then
                        filter.iOR(SysPagesTable.PageName, BaseFilter.ComparisonOperator.EqualsTo, item.Value, False, False)
                    End If
                Next
                wc.iAND(filter)
      ...
      cols.Add(SysPagesTable.PageName, True)
    ...
    End Function
      ...
      Dim appRelativeVirtualPath As String = CType(HttpContext.Current.Session("AppRelativeVirtualPath"), String)
            ...
            If Not isNothing(PageNameFilterSelectedValue) Then
                ...
                For Each item As String In PageNameFilteritemListFromSession
                    ...
                    Else
                        filter.iOR(SysPagesTable.PageName, BaseFilter.ComparisonOperator.EqualsTo, item, False, False)
                        index += 1
                    End If
                Next
                wc.iAND(filter)
      ...
      Next
        ...
        Public Overridable Function GetAutoCompletionList_SearchText(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim recordList () As ePortalWFApproval.Business.SysPagesRecord = SysPagesTable.GetRecords(filterJoin, wc, Nothing, 0, count,count)
            Dim rec As SysPagesRecord = Nothing
            ...
            For Each rec In recordList 
                ...
                resultItem = rec.Format(SysPagesTable.PageName)
                If resultItem IsNot Nothing Then
                    Dim prText As String = prefixText
                    If SysPagesTable.PageName.IsFullTextSearchable Then
                    ...
                    If Not String.IsNullOrEmpty(prText) AndAlso resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))  Then
                        ...
                        Dim isAdded As Boolean = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, SysPagesTable.PageName.IsFullTextSearchable)
                        If isAdded Then
                            Continue For
                        End If
                    End If
    ...
    Dim recControl As SysPagesTableControlRow = DirectCast(repItem.FindControl("SysPagesTableControlRow"), SysPagesTableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        Dim rec As SysPagesRecord = New SysPagesRecord()
        
                        If recControl.Checked0.Text <> "" Then
                            rec.Parse(recControl.Checked0.Text, SysPagesTable.Checked0)
                        End If
                        If recControl.DateCreated.Text <> "" Then
                            rec.Parse(recControl.DateCreated.Text, SysPagesTable.DateCreated)
                        End If
                        If recControl.isDisplay.Text <> "" Then
                            rec.Parse(recControl.isDisplay.Text, SysPagesTable.isDisplay)
                        End If
                        If recControl.Level.Text <> "" Then
                            rec.Parse(recControl.Level.Text, SysPagesTable.Level)
                        End If
                        If recControl.PageName.Text <> "" Then
                            rec.Parse(recControl.PageName.Text, SysPagesTable.PageName)
                        End If
                        If recControl.ParentID.Text <> "" Then
                            rec.Parse(recControl.ParentID.Text, SysPagesTable.ParentID)
                        End If
                        If recControl.Sorting.Text <> "" Then
                            rec.Parse(recControl.Sorting.Text, SysPagesTable.Sorting)
                        End If
                        If recControl.SystemID.Text <> "" Then
                            rec.Parse(recControl.SystemID.Text, SysPagesTable.SystemID)
                        End If
                        If recControl.URL.Text <> "" Then
                            rec.Parse(recControl.URL.Text, SysPagesTable.URL)
                        End If
            ...
            For index = 1 To Me.AddNewRecord
                ...
                newRecordList.Insert(0, New SysPagesRecord())
            ...
            If newRecordList.Count > 0 Then
                ...
                Me.DataSource = DirectCast(finalList.ToArray(GetType(SysPagesRecord)), SysPagesRecord())
        ...
        Public Sub AddToDeletedRecordIds(ByVal rec As SysPagesTableControlRow)
        ...
        Protected Overridable Function InDeletedRecordIds(ByVal rec As SysPagesTableControlRow) As Boolean
        ...
        Public Overridable Sub SetPageNameFilter()
            ...
            Me.PopulatePageNameFilter(GetSelectedValueList(Me.PageNameFilter, PageNameFilterselectedFilterItemList), 500)
              ...
              Dim url as String = Me.ModifyRedirectUrl("../SysPages/SysPages-QuickSelector.aspx", "", True)
        ...
        Protected Overridable Sub PopulatePageNameFilter(ByVal selectedValue As ArrayList, ByVal maxItems As Integer)
            ...
            orderBy.Add(SysPagesTable.PageName, OrderByItem.OrderDir.Asc)                
            ...
            If wc.RunQuery Then
                ...
                values = SysPagesTable.GetValues(SysPagesTable.PageName, wc, orderBy, maxItems)
            ...
            For Each cvalue In values
                ...
                If ( SysPagesTable.PageName.IsColumnValueTypeBoolean()) Then
                    fvalue = cvalue
                Else
                    fvalue = SysPagesTable.PageName.Format(cvalue)
                End If
        ...
        Public Overridable Function CreateWhereClause_PageNameFilter() As WhereClause
            ...
            Else            
                For Each item As String In PageNameFilterselectedFilterItemList
                    ...
                    wc.iOR(SysPagesTable.PageName, BaseFilter.ComparisonOperator.EqualsTo, item)
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Me.RemoveFromSession(Me, "Page_Size")
        ...
        Protected Overrides Sub LoadViewState(ByVal savedState As Object)
            ...
            Dim orderByStr As String = CType(ViewState("SysPagesTableControl_OrderBy"), String)
        ...
        Protected Overrides Function SaveViewState() As Object
            ...
            If Me.CurrentSortOrder IsNot Nothing Then
                Me.ViewState("SysPagesTableControl_OrderBy") = Me.CurrentSortOrder.ToXmlString()
            End If
        ...
        Public Overridable Sub SetImportButton()                
                    ...
                    Me.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=SysPages" 
        ...
        Public Overridable Sub SetNewButton()                
              ...
              Try        
                    ...
                    url = url & "&RedirectStyle=" & CType(Me.Page, BaseApplicationPage).Encrypt("Popup") & "&Target=" & CType(Me.Page, BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(Me, "SysPagesTableControl_PostbackTracker").ClientID)                           
                                
                Dim javascriptCall as String = ""
                
                    javascriptCall = "initializePopupPage2(document.getElementById('" & MiscUtils.FindControlRecursively(Me, "SysPagesTableControl_PostbackTracker").ClientID & "'), '" & url & "', true, event);"                                      
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            ' Create the Order By clause based on the user's current sorting preference.
              ...
              Me.TotalRecords = SysPagesTable.GetRecordCount(join, wc)
              If Me.TotalRecords > 10000 Then
          
              ' Add each of the columns in order of export.
              Dim columns() as BaseColumn = New BaseColumn() { _
                         SysPagesTable.PageName, _ 
             SysPagesTable.ParentID, _ 
             SysPagesTable.Level, _ 
             SysPagesTable.URL, _ 
             SysPagesTable.DateCreated, _ 
             SysPagesTable.Sorting, _ 
             SysPagesTable.isDisplay, _ 
             SysPagesTable.Checked0, _ 
             SysPagesTable.SystemID, _ 
             Nothing}
              Dim  exportData as ExportDataToCSV = New ExportDataToCSV(SysPagesTable.Instance, wc, orderBy, columns)
              exportData.StartExport(Me.Page.Response, True)

              Dim dataForCSV As DataForExport = New DataForExport(SysPagesTable.Instance, wc, orderBy, columns, join)
          ...
          Else
              ...
              Dim excelReport As ExportDataToExcel = New ExportDataToExcel(SysPagesTable.Instance, wc, orderBy)
              ' Add each of the columns in order of export.
              ...
              Dim data As DataForExport = New DataForExport(SysPagesTable.Instance, wc, orderBy, Nothing, join)
                       data.ColumnList.Add(New ExcelColumn(SysPagesTable.PageName, "Default"))
             data.ColumnList.Add(New ExcelColumn(SysPagesTable.ParentID, "0"))
             data.ColumnList.Add(New ExcelColumn(SysPagesTable.Level, "0"))
             data.ColumnList.Add(New ExcelColumn(SysPagesTable.URL, "Default"))
             data.ColumnList.Add(New ExcelColumn(SysPagesTable.DateCreated, "Short Date"))
             data.ColumnList.Add(New ExcelColumn(SysPagesTable.Sorting, "Default"))
             data.ColumnList.Add(New ExcelColumn(SysPagesTable.isDisplay, "Default"))
             data.ColumnList.Add(New ExcelColumn(SysPagesTable.Checked0, "Default"))
             data.ColumnList.Add(New ExcelColumn(SysPagesTable.SystemID, "0"))
                  ...
                  For Each rec As BaseRecord In recList
                      ...
                      For Each col As ExcelColumn In data.ColumnList
                          ...
                          If _isExpandableNonCompositeForeignKey AndAlso col.DisplayColumn.IsApplyDisplayAs Then
                              val = SysPagesTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, Nothing)
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-SysPages-Table.PDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "SysPages"
                ' If Show-SysPages-Table.PDFButton.report specifies a valid report template,
                ...
                ' The 5th parameter represents the relative width of the column   			
                 report.AddColumn(SysPagesTable.PageName.Name, ReportEnum.Align.Left, "${PageName}", ReportEnum.Align.Left, 28)
                 report.AddColumn(SysPagesTable.ParentID.Name, ReportEnum.Align.Right, "${ParentID}", ReportEnum.Align.Right, 15)
                 report.AddColumn(SysPagesTable.Level.Name, ReportEnum.Align.Right, "${Level}", ReportEnum.Align.Right, 15)
                 report.AddColumn(SysPagesTable.URL.Name, ReportEnum.Align.Left, "${URL}", ReportEnum.Align.Left, 30)
                 report.AddColumn(SysPagesTable.DateCreated.Name, ReportEnum.Align.Left, "${DateCreated}", ReportEnum.Align.Left, 20)
                 report.AddColumn(SysPagesTable.Sorting.Name, ReportEnum.Align.Left, "${Sorting}", ReportEnum.Align.Left, 28)
                 report.AddColumn(SysPagesTable.isDisplay.Name, ReportEnum.Align.Left, "${isDisplay}", ReportEnum.Align.Left, 15)
                 report.AddColumn(SysPagesTable.Checked0.Name, ReportEnum.Align.Left, "${Checked0}", ReportEnum.Align.Left, 15)
                 report.AddColumn(SysPagesTable.SystemID.Name, ReportEnum.Align.Right, "${SystemID}", ReportEnum.Align.Right, 15)
              ...
              Dim joinFilter As BaseFilter = CreateCompoundJoinFilter()
                ...
                Dim totalRows As Integer = SysPagesTable.GetRecordCount(joinFilter,whereClause)
                Dim columns As ColumnList = SysPagesTable.GetColumnList()
                Dim records As SysPagesRecord() = Nothing
            
                Do 
                    
                    records = SysPagesTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery)
                    If Not (records Is Nothing) AndAlso records.Length > 0 AndAlso whereClause.RunQuery Then
                      For Each record As SysPagesRecord In records 
                            ...
                            ' The 4th parameters represent the maximum length of the data value being shown
                                                         report.AddData("${PageName}", record.Format(SysPagesTable.PageName), ReportEnum.Align.Left, 300)
                             report.AddData("${ParentID}", record.Format(SysPagesTable.ParentID), ReportEnum.Align.Right, 300)
                             report.AddData("${Level}", record.Format(SysPagesTable.Level), ReportEnum.Align.Right, 300)
                             report.AddData("${URL}", record.Format(SysPagesTable.URL), ReportEnum.Align.Left, 300)
                             report.AddData("${DateCreated}", record.Format(SysPagesTable.DateCreated), ReportEnum.Align.Left, 300)
                             report.AddData("${Sorting}", record.Format(SysPagesTable.Sorting), ReportEnum.Align.Left, 300)
                             report.AddData("${isDisplay}", record.Format(SysPagesTable.isDisplay), ReportEnum.Align.Left, 300)
                             report.AddData("${Checked0}", record.Format(SysPagesTable.Checked0), ReportEnum.Align.Left, 300)
                             report.AddData("${SystemID}", record.Format(SysPagesTable.SystemID), ReportEnum.Align.Right, 300)
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-SysPages-Table.WordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "SysPages"
                ' If Show-SysPages-Table.WordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
    ...
    Try
        ...
        Protected Overridable Sub SortControl_SelectedIndexChanged(ByVal sender As Object, ByVal args As EventArgs)
                ...
                For Each ColumnNam As BaseClasses.Data.BaseColumn In SysPagesTable.GetColumns()
                ...
                Dim sd As OrderByItem= Me.CurrentSortOrder.Find(SysPagesTable.GetColumnByName(SelVal1))
                If sd Is Nothing Or Not Me.CurrentSortOrder.Items Is Nothing Then
                'First time sort, so add sort order for Discontinued.
                If Not SysPagesTable.GetColumnByName(SelVal1) Is Nothing Then
                  Me.CurrentSortOrder.Reset()
                End If
            ...
            If SelVal1 <> "--PLEASE_SELECT--" AndAlso Not SysPagesTable.GetColumnByName(SelVal1) Is Nothing Then
                  If  words1(words1.Length() - 1).Contains("ASC") Then
            Me.CurrentSortOrder.Add(SysPagesTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc)
                  Elseif words1(words1.Length() - 1).Contains("DESC") Then
            Me.CurrentSortOrder.Add(SysPagesTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc)
                  End If
                End If
        ...
        Public Property TotalRecords() As Integer
            Get
                If _TotalRecords < 0 
                    _TotalRecords = SysPagesTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause())
                End If
...
#Region "Helper Functions"
        ...
        Public Overrides Overloads Function EvaluateExpressions(url As String, arg As String, ByVal bEncrypt As Boolean) As String
            ...
            If (needToProcess) Then
                Dim recCtl As SysPagesTableControlRow = Me.GetSelectedRecordControl()
        ...
        Public Overridable Function GetSelectedRecordControl() As SysPagesTableControlRow
            Return Nothing
          
        End Function

        Public Overridable Function GetSelectedRecordControls() As SysPagesTableControlRow()
        
            Return DirectCast((new ArrayList()).ToArray(GetType(SysPagesTableControlRow)), SysPagesTableControlRow())
          
        End Function

        Public Overridable Sub DeleteSelectedRecords(ByVal deferDeletion As Boolean)
            Dim recList() As SysPagesTableControlRow = Me.GetSelectedRecordControls()
        ...
        Public Overridable Function GetRecordControls() As SysPagesTableControlRow()
            Dim recCtrls() As Control = BaseClasses.Utils.MiscUtils.FindControlsRecursively(Me, "SysPagesTableControlRow")
            Dim list As New List(Of SysPagesTableControlRow)
            For Each recCtrl As SysPagesTableControlRow In recCtrls
                list.Add(recCtrl)
            Next
            Return list.ToArray()
        End Function
