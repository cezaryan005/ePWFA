...
' WAttach_Type_QuickSelector1.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.WAttach_Type_QuickSelector1
...
' Base class for the SelectorTableControlRow control on the WAttach_Type_QuickSelector1 page.
...
Public Class BaseSelectorTableControlRow
        ...
        Public Overridable Sub LoadData()        
            ...
            ' Load the data from the database into the DataSource DatabaseANFLO-WFN%dbo.WAttach_Type record.
            ...
            If Me.RecordUniqueId IsNot Nothing AndAlso Me.RecordUniqueId.Trim <> "" Then
                Me.DataSource = WAttach_Type1Table.GetRecord(Me.RecordUniqueId, True)
            ...
            Me.DataSource = New WAttach_Type1Record()
        ...
        Public Overridable Sub Delete()
          ...
          WAttach_Type1Table.DeleteRecord(pkValue)
        ...
        Public Property DataSource() As WAttach_Type1Record
            Get
                Return DirectCast(MyBase._DataSource, WAttach_Type1Record)
            End Get
            Set(ByVal value As WAttach_Type1Record)
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetRecord() As WAttach_Type1Record
            ...
            If Not Me.RecordUniqueId Is Nothing Then
                ...
                Return WAttach_Type1Table.GetRecord(Me.RecordUniqueId, True)
...
' Base class for the SelectorTableControl control on the WAttach_Type_QuickSelector1 page.
...
Public Class BaseSelectorTableControl
    ...
    ' Setup default pagination settings.
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                If wc IsNot Nothing AndAlso Not wc.RunQuery Then
                    ...
                    Me.DataSource = DirectCast(alist.ToArray(GetType(WAttach_Type1Record)), WAttach_Type1Record())
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    ...
                    For Each rc As SelectorTableControlRow In Me.GetRecordControls()
                        ...
                        End If
                    Next
                    Me.DataSource = DirectCast(postdata.ToArray(GetType(WAttach_Type1Record)), WAttach_Type1Record())
        ...
        Public Overridable Function GetRecords( _
            ...
            ' selCols.Add(WAttach_Type1Table.Column1, True)         
            ' selCols.Add(WAttach_Type1Table.Column2, True)          
            ' selCols.Add(WAttach_Type1Table.Column3, True)    
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return WAttach_Type1Table.GetRecords(join, where, orderBy, Me.PageIndex, Me.PageSize)
                 
            Else
                Dim databaseTable As New WAttach_Type1Table
                ...
                Return CType(recList.ToArray(GetType(WAttach_Type1Record)), WAttach_Type1Record())
            End If            
        ...
        Public Overridable Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return WAttach_Type1Table.GetRecordCount(join, where)
        ...
        Public Overridable Function GetColumnListFromURLParameters(ByVal includeIndexFieldParameter As Boolean, ByVal includeFormulaAndDFKAParameter As Boolean) As ColumnList
            ...
            If includeIndexFieldParameter AndAlso field <> "" Then
                Dim col As BaseColumn = WAttach_Type1Table.GetColumnByName(field)
                If col IsNot Nothing  AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
            End If
            If includeFormulaAndDFKAParameter Then
                If formula <> "" Then
                    For Each col As BaseColumn In MiscUtils.GetFormulaFieldList(formula, WAttach_Type1Table.Instance.TableDefinition)
                        If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                    Next
                
                ElseIf displayFieldName <> ""
                    Dim col As BaseColumn = WAttach_Type1Table.GetColumnByName(displayFieldName)
                    If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                End If
            End If
            Return columnList            
    ...
    End Sub
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            WAttach_Type1Table.Instance.InnerFilter = Nothing
      ...
      Next
            ...
            End If
		        ...
		        If Not String.IsNullOrEmpty(Me.Page.Request("dependOnField")) AndAlso Me.Page.Request("dependOnVal") IsNot Nothing Then
			          Dim dependOnCol as BaseColumn = WAttach_Type1Table.GetColumnByName(Me.Page.GetDecryptedURLParameter("dependOnField"))
    ...
    End Function
      ...
      Next
        ...
        Public Overridable Function GetAutoCompletionList_Search(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim recordList () As ePortalWFApproval.Business.WAttach_Type1Record = WAttach_Type1Table.GetRecords(filterJoin, wc, Nothing, 0, count,count)
            Dim rec As WAttach_Type1Record = Nothing
    ...
    Dim recControl As SelectorTableControlRow = DirectCast(repItem.FindControl("SelectorTableControlRow"), SelectorTableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        Dim rec As WAttach_Type1Record = New WAttach_Type1Record()
            ...
            For index = 1 To Me.AddNewRecord
                ...
                newRecordList.Insert(0, New WAttach_Type1Record())
            ...
            If newRecordList.Count > 0 Then
                ...
                Me.DataSource = DirectCast(finalList.ToArray(GetType(WAttach_Type1Record)), WAttach_Type1Record())
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Try
        ...
        Public Property TotalRecords() As Integer
            Get
                If _TotalRecords < 0 
                    _TotalRecords = WAttach_Type1Table.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause())
                End If
