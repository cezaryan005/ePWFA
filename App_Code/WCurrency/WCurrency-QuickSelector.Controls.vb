...
' WCurrency_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.WCurrency_QuickSelector
...
' Base class for the SelectorTableControlRow control on the WCurrency_QuickSelector page.
...
Public Class BaseSelectorTableControlRow
        ...
        Public Overridable Sub LoadData()        
            ...
            ' Load the data from the database into the DataSource DatabaseANFLO-WF%dbo.WCurrency record.
            ...
            If Me.RecordUniqueId IsNot Nothing AndAlso Me.RecordUniqueId.Trim <> "" Then
                Me.DataSource = WCurrencyTable.GetRecord(Me.RecordUniqueId, True)
            ...
            Me.DataSource = New WCurrencyRecord()
        ...
        Public Overridable Sub Delete()
          ...
          WCurrencyTable.DeleteRecord(pkValue)
        ...
        Public Property DataSource() As WCurrencyRecord
            Get
                Return DirectCast(MyBase._DataSource, WCurrencyRecord)
            End Get
            Set(ByVal value As WCurrencyRecord)
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetRecord() As WCurrencyRecord
            ...
            If Not Me.RecordUniqueId Is Nothing Then
                ...
                Return WCurrencyTable.GetRecord(Me.RecordUniqueId, True)
...
' Base class for the SelectorTableControl control on the WCurrency_QuickSelector page.
...
Public Class BaseSelectorTableControl
    ...
    ' Setup default pagination settings.
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                If wc IsNot Nothing AndAlso Not wc.RunQuery Then
                    ...
                    Me.DataSource = DirectCast(alist.ToArray(GetType(WCurrencyRecord)), WCurrencyRecord())
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    ...
                    For Each rc As SelectorTableControlRow In Me.GetRecordControls()
                        ...
                        End If
                    Next
                    Me.DataSource = DirectCast(postdata.ToArray(GetType(WCurrencyRecord)), WCurrencyRecord())
        ...
        Public Overridable Function GetRecords( _
            ...
            ' selCols.Add(WCurrencyTable.Column1, True)         
            ' selCols.Add(WCurrencyTable.Column2, True)          
            ' selCols.Add(WCurrencyTable.Column3, True)    
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return WCurrencyTable.GetRecords(join, where, orderBy, Me.PageIndex, Me.PageSize)
                 
            Else
                Dim databaseTable As New WCurrencyTable
                ...
                Return CType(recList.ToArray(GetType(WCurrencyRecord)), WCurrencyRecord())
            End If            
        ...
        Public Overridable Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return WCurrencyTable.GetRecordCount(join, where)
        ...
        Public Overridable Function GetColumnListFromURLParameters(ByVal includeIndexFieldParameter As Boolean, ByVal includeFormulaAndDFKAParameter As Boolean) As ColumnList
            ...
            If includeIndexFieldParameter AndAlso field <> "" Then
                Dim col As BaseColumn = WCurrencyTable.GetColumnByName(field)
                If col IsNot Nothing  AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
            End If
            If includeFormulaAndDFKAParameter Then
                If formula <> "" Then
                    For Each col As BaseColumn In MiscUtils.GetFormulaFieldList(formula, WCurrencyTable.Instance.TableDefinition)
                        If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                    Next
                
                ElseIf displayFieldName <> ""
                    Dim col As BaseColumn = WCurrencyTable.GetColumnByName(displayFieldName)
                    If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                End If
            End If
            Return columnList            
    ...
    End Sub
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            WCurrencyTable.Instance.InnerFilter = Nothing
      ...
      Next
            ...
            End If
		        ...
		        If Not String.IsNullOrEmpty(Me.Page.Request("dependOnField")) AndAlso Me.Page.Request("dependOnVal") IsNot Nothing Then
			          Dim dependOnCol as BaseColumn = WCurrencyTable.GetColumnByName(Me.Page.GetDecryptedURLParameter("dependOnField"))
    ...
    End Function
      ...
      Next
        ...
        Public Overridable Function GetAutoCompletionList_Search(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim recordList () As ePortalWFApproval.Business.WCurrencyRecord = WCurrencyTable.GetRecords(filterJoin, wc, Nothing, 0, count,count)
            Dim rec As WCurrencyRecord = Nothing
    ...
    Dim recControl As SelectorTableControlRow = DirectCast(repItem.FindControl("SelectorTableControlRow"), SelectorTableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        Dim rec As WCurrencyRecord = New WCurrencyRecord()
            ...
            For index = 1 To Me.AddNewRecord
                ...
                newRecordList.Insert(0, New WCurrencyRecord())
            ...
            If newRecordList.Count > 0 Then
                ...
                Me.DataSource = DirectCast(finalList.ToArray(GetType(WCurrencyRecord)), WCurrencyRecord())
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Try
        ...
        Public Property TotalRecords() As Integer
            Get
                If _TotalRecords < 0 
                    _TotalRecords = WCurrencyTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause())
                End If
