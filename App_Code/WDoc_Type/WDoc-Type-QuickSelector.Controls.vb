...
' WDoc_Type_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.WDoc_Type_QuickSelector
...
' Base class for the SelectorTableControlRow control on the WDoc_Type_QuickSelector page.
...
Public Class BaseSelectorTableControlRow
        ...
        Public Overridable Sub LoadData()        
            ...
            ' Load the data from the database into the DataSource DatabaseANFLO-WF%dbo.WDoc_Type record.
            ...
            If Me.RecordUniqueId IsNot Nothing AndAlso Me.RecordUniqueId.Trim <> "" Then
                Me.DataSource = WDoc_TypeTable.GetRecord(Me.RecordUniqueId, True)
            ...
            Me.DataSource = New WDoc_TypeRecord()
        ...
        Public Overridable Sub Delete()
          ...
          WDoc_TypeTable.DeleteRecord(pkValue)
        ...
        Public Property DataSource() As WDoc_TypeRecord
            Get
                Return DirectCast(MyBase._DataSource, WDoc_TypeRecord)
            End Get
            Set(ByVal value As WDoc_TypeRecord)
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetRecord() As WDoc_TypeRecord
            ...
            If Not Me.RecordUniqueId Is Nothing Then
                ...
                Return WDoc_TypeTable.GetRecord(Me.RecordUniqueId, True)
...
' Base class for the SelectorTableControl control on the WDoc_Type_QuickSelector page.
...
Public Class BaseSelectorTableControl
    ...
    ' Setup default pagination settings.
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                If wc IsNot Nothing AndAlso Not wc.RunQuery Then
                    ...
                    Me.DataSource = DirectCast(alist.ToArray(GetType(WDoc_TypeRecord)), WDoc_TypeRecord())
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    ...
                    For Each rc As SelectorTableControlRow In Me.GetRecordControls()
                        ...
                        End If
                    Next
                    Me.DataSource = DirectCast(postdata.ToArray(GetType(WDoc_TypeRecord)), WDoc_TypeRecord())
        ...
        Public Overridable Function GetRecords( _
            ...
            ' selCols.Add(WDoc_TypeTable.Column1, True)         
            ' selCols.Add(WDoc_TypeTable.Column2, True)          
            ' selCols.Add(WDoc_TypeTable.Column3, True)    
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return WDoc_TypeTable.GetRecords(join, where, orderBy, Me.PageIndex, Me.PageSize)
                 
            Else
                Dim databaseTable As New WDoc_TypeTable
                ...
                Return CType(recList.ToArray(GetType(WDoc_TypeRecord)), WDoc_TypeRecord())
            End If            
        ...
        Public Overridable Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return WDoc_TypeTable.GetRecordCount(join, where)
        ...
        Public Overridable Function GetColumnListFromURLParameters(ByVal includeIndexFieldParameter As Boolean, ByVal includeFormulaAndDFKAParameter As Boolean) As ColumnList
            ...
            If includeIndexFieldParameter AndAlso field <> "" Then
                Dim col As BaseColumn = WDoc_TypeTable.GetColumnByName(field)
                If col IsNot Nothing  AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
            End If
            If includeFormulaAndDFKAParameter Then
                If formula <> "" Then
                    For Each col As BaseColumn In MiscUtils.GetFormulaFieldList(formula, WDoc_TypeTable.Instance.TableDefinition)
                        If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                    Next
                
                ElseIf displayFieldName <> ""
                    Dim col As BaseColumn = WDoc_TypeTable.GetColumnByName(displayFieldName)
                    If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                End If
            End If
            Return columnList            
    ...
    End Sub
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            WDoc_TypeTable.Instance.InnerFilter = Nothing
      ...
      Next
            ...
            End If
		        ...
		        If Not String.IsNullOrEmpty(Me.Page.Request("dependOnField")) AndAlso Me.Page.Request("dependOnVal") IsNot Nothing Then
			          Dim dependOnCol as BaseColumn = WDoc_TypeTable.GetColumnByName(Me.Page.GetDecryptedURLParameter("dependOnField"))
    ...
    End Function
      ...
      Next
        ...
        Public Overridable Function GetAutoCompletionList_Search(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim recordList () As ePortalWFApproval.Business.WDoc_TypeRecord = WDoc_TypeTable.GetRecords(filterJoin, wc, Nothing, 0, count,count)
            Dim rec As WDoc_TypeRecord = Nothing
    ...
    Dim recControl As SelectorTableControlRow = DirectCast(repItem.FindControl("SelectorTableControlRow"), SelectorTableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        Dim rec As WDoc_TypeRecord = New WDoc_TypeRecord()
            ...
            For index = 1 To Me.AddNewRecord
                ...
                newRecordList.Insert(0, New WDoc_TypeRecord())
            ...
            If newRecordList.Count > 0 Then
                ...
                Me.DataSource = DirectCast(finalList.ToArray(GetType(WDoc_TypeRecord)), WDoc_TypeRecord())
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Try
        ...
        Public Property TotalRecords() As Integer
            Get
                If _TotalRecords < 0 
                    _TotalRecords = WDoc_TypeTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause())
                End If
