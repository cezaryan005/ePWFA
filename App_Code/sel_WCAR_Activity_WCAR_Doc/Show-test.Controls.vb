...
' Show_test.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.Show_test
...
' Base class for the Sel_WCAR_Activity_WCAR_DocTableControlRow control on the Show_test page.
...
Public Class BaseSel_WCAR_Activity_WCAR_DocTableControlRow
        ...
        Public Overridable Sub SetTabPanelA()

                  
                  
                  End Sub
                
        Public Overridable Sub SetTabPanelB()
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property TabPanelA() As AjaxControlToolkit.TabPanel
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "TabPanelA"), AjaxControlToolkit.TabPanel)
            End Get
        End Property
        
        Public ReadOnly Property TabPanelB() As AjaxControlToolkit.TabPanel
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "TabPanelB"), AjaxControlToolkit.TabPanel)
            End Get
        End Property
...
' Base class for the Sel_WCAR_Activity_WCAR_DocTableControl control on the Show_test page.
...
Public Class BaseSel_WCAR_Activity_WCAR_DocTableControl
        ...
        Protected Overridable Sub Control_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Init
           ...
           ' Setup the filter and search.
            ...
            If Not Me.Page.IsPostBack Then
                Dim initialVal As String = ""
                If  Me.InSession(Me.WCA_StatusFilter) 				
                    initialVal = Me.GetFromSession(Me.WCA_StatusFilter)
                
                Else
                    
                    initialVal = EvaluateFormula("URL(""WCA_Status"")")
              ...
              End If
                ...
                If initialVal <> ""				
                        ...
                        Dim WCA_StatusFilteritemListFromSession() As String = initialVal.Split(","c)
                        Dim index As Integer = 0
                        For Each item As String In WCA_StatusFilteritemListFromSession
                            If index = 0 AndAlso _
                               item.ToString.Equals("") Then
                            Else
                                Me.WCA_StatusFilter.Items.Add(item)
                                Me.WCA_StatusFilter.Items.Item(index).Selected = True
                                index += 1
                            End If
                        Next
                        Dim listItem As ListItem
                        For Each listItem In Me.WCA_StatusFilter.Items
    ...
    ' Setup default pagination settings.
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            ' Setup the sorting events.
              ...
              AddHandler Me.WCA_Date_AssignLabel.Click, AddressOf WCA_Date_AssignLabel_Click
            
              AddHandler Me.WCA_StatusLabel.Click, AddressOf WCA_StatusLabel_Click
            
              AddHandler Me.WCA_W_U_IDLabel.Click, AddressOf WCA_W_U_IDLabel_Click
            
              AddHandler Me.WCA_WDT_IDLabel.Click, AddressOf WCA_WDT_IDLabel_Click
            
              AddHandler Me.WCD_Exp_TotalLabel.Click, AddressOf WCD_Exp_TotalLabel_Click
            
              AddHandler Me.WCD_NoLabel.Click, AddressOf WCD_NoLabel_Click
            ...
            AddHandler Me.SortControl.SelectedIndexChanged, AddressOf SortControl_SelectedIndexChanged
              AddHandler Me.WCA_StatusFilter.SelectedIndexChanged, AddressOf WCA_StatusFilter_SelectedIndexChanged                  
    ...
    End Sub
        ...
        Public Overridable Sub ResetControl()
            ...
            Me.WCA_StatusFilter.ClearSelection()
        ...
        Dim hasFiltersSel_WCAR_Activity_WCAR_DocTableControl As Boolean = False
            ...
            If IsValueSelected(Me.WCA_StatusFilter) Then
              ...
              hasFiltersSel_WCAR_Activity_WCAR_DocTableControl = True            
                ...
                For Each item In Me.WCA_StatusFilter.Items
                ...
                For Each item In Me.WCA_StatusFilter.Items
                    ...
                    End If
                    If item.Selected Then
                        filter.iOR(Sel_WCAR_Activity_WCAR_DocView.WCA_Status, BaseFilter.ComparisonOperator.EqualsTo, item.Value, False, False)
                    End If
                Next
                wc.iAND(filter)
    ...
    End Function
      ...
      Dim appRelativeVirtualPath As String = CType(HttpContext.Current.Session("AppRelativeVirtualPath"), String)
            ...
            Dim WCA_StatusFilterSelectedValue As String = CType(HttpContext.Current.Session()(HttpContext.Current.Session.SessionID & appRelativeVirtualPath & "WCA_StatusFilter_Ajax"), String)
            If IsValueSelected(WCA_StatusFilterSelectedValue) Then
    
              hasFiltersSel_WCAR_Activity_WCAR_DocTableControl = True            
    
            If Not isNothing(WCA_StatusFilterSelectedValue) Then
                Dim WCA_StatusFilteritemListFromSession() As String = WCA_StatusFilterSelectedValue.Split(","c)
                Dim index As Integer = 0
                ...
                For Each item As String In WCA_StatusFilteritemListFromSession
                    ...
                    Else
                        filter.iOR(Sel_WCAR_Activity_WCAR_DocView.WCA_Status, BaseFilter.ComparisonOperator.EqualsTo, item, False, False)
                        index += 1
                    End If
                Next
                wc.iAND(filter)
    ...
    Dim recControl As Sel_WCAR_Activity_WCAR_DocTableControlRow = DirectCast(repItem.FindControl("Sel_WCAR_Activity_WCAR_DocTableControlRow"), Sel_WCAR_Activity_WCAR_DocTableControlRow)
        ...
        Public Overridable Sub SetWCA_StatusFilter()

              
            
            Dim WCA_StatusFilterselectedFilterItemList As New ArrayList()
            Dim WCA_StatusFilteritemsString As String = Nothing
            If (Me.InSession(Me.WCA_StatusFilter)) Then
                WCA_StatusFilteritemsString = Me.GetFromSession(Me.WCA_StatusFilter)
            End If
            
            If (WCA_StatusFilteritemsString IsNot Nothing) Then
                Dim WCA_StatusFilteritemListFromSession() As String = WCA_StatusFilteritemsString.Split(","c)
                For Each item as String In WCA_StatusFilteritemListFromSession
                    WCA_StatusFilterselectedFilterItemList.Add(item)
                Next
            End If
              
            		
            Me.PopulateWCA_StatusFilter(GetSelectedValueList(Me.WCA_StatusFilter, WCA_StatusFilterselectedFilterItemList), 500)
              ...
              url &= "?Target=" & Me.WCA_StatusFilter.ClientID & "&IndexField=" & CType(Me.Page, BaseApplicationPage).Encrypt("WCA_Status")& "&EmptyValue=" & CType(Me.Page, BaseApplicationPage).Encrypt("--ANY--") & "&EmptyDisplayText=" & CType(Me.Page, BaseApplicationPage).Encrypt(Me.Page.GetResourceValue("Txt:All")) & "&RedirectStyle=" & CType(Me.Page, BaseApplicationPage).Encrypt("Popup")
              
              
              Me.WCA_StatusFilter.Attributes.Item("onClick") = "initializePopupPage(this, '" & url & "', " & Convert.ToString(WCA_StatusFilter.AutoPostBack).ToLower() & ", event); return false;"        
        ...
        Protected Overridable Sub PopulateSortControl(ByVal selectedValue As String, ByVal maxItems As Integer)
            ...
            Me.SortControl.Items.Add(New ListItem(Me.Page.ExpandResourceValue("WCA {Txt:Ascending}"), "WCA_ID Asc"))
                            							
            Me.SortControl.Items.Add(New ListItem(Me.Page.ExpandResourceValue("WCA {Txt:Descending}"), "WCA_ID Desc"))
        ...
        ' Get the filters' data for WCA_StatusFilter
        Protected Overridable Sub PopulateWCA_StatusFilter(ByVal selectedValue As ArrayList, ByVal maxItems As Integer)
            ...
            ' Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_WCA_StatusFilter function.
            ...
            If wc.RunQuery Then
                ...
                values = Sel_WCAR_Activity_WCAR_DocView.GetValues(Sel_WCAR_Activity_WCAR_DocView.WCA_Status, wc, orderBy, maxItems)
            ...
            For Each cvalue In values
                ...
                If ( Sel_WCAR_Activity_WCAR_DocView.WCA_Status.IsColumnValueTypeBoolean()) Then
                    fvalue = cvalue
                Else
                    fvalue = Sel_WCAR_Activity_WCAR_DocView.WCA_Status.Format(cvalue)
                End If
                ...
                Dim dupItem As ListItem = Me.WCA_StatusFilter.Items.FindByText(fvalue)
                ...
                Me.WCA_StatusFilter.Items.Add(newItem)
            ...
            Me.WCA_StatusFilter.SetFieldMaxLength(50)
                                 
                  
            ' Add the selected value.
            If Me.WCA_StatusFilter.Items.Count = 0 Then
                Me.WCA_StatusFilter.Items.Add(New ListItem(Page.GetResourceValue("Txt:All", "ePortalWFApproval"), "--ANY--"))
            End If
            
            ' Mark all items to be selected.
            For Each item As ListItem in Me.WCA_StatusFilter.Items
                item.Selected = True
            Next
        ...
        Public Overridable Function CreateWhereClause_WCA_StatusFilter() As WhereClause
          
              Dim hasFiltersSel_WCAR_Activity_WCAR_DocTableControl As Boolean = False
            
            ' Create a where clause for the filter WCA_StatusFilter.
            ' This function is called by the Populate method to load the items 
            ' in the WCA_StatusFilterQuickSelector
            ...
            WCA_StatusFilterselectedFilterItemList = GetSelectedValueList(Me.WCA_StatusFilter, WCA_StatusFilterselectedFilterItemList) 
            Dim wc As New WhereClause
            If WCA_StatusFilterselectedFilterItemList Is Nothing OrElse WCA_StatusFilterselectedFilterItemList.Count = 0 Then
                wc.RunQuery = False
            Else            
                For Each item As String In WCA_StatusFilterselectedFilterItemList
              
            
      
   
                    wc.iOR(Sel_WCAR_Activity_WCAR_DocView.WCA_Status, BaseFilter.ComparisonOperator.EqualsTo, item)
        ...
        Protected Overrides Sub SaveControlsToSession()
            ...
            Dim WCA_StatusFilterselectedFilterItemList As ArrayList = GetSelectedValueList(Me.WCA_StatusFilter, Nothing)
            Dim WCA_StatusFilterSessionString As String = ""
            If Not WCA_StatusFilterselectedFilterItemList is Nothing Then
            For Each item As String In WCA_StatusFilterselectedFilterItemList
                WCA_StatusFilterSessionstring = WCA_StatusFilterSessionstring & "," & item
            Next
            End If
            Me.SaveToSession(Me.WCA_StatusFilter, WCA_StatusFilterSessionstring)
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
        ...
        Protected  Sub SaveControlsToSession_Ajax()
            ...
            Next
            End If
            Me.SaveToSession("WCA_StatusFilter_Ajax", WCA_StatusFilterSessionString)
        ...
        Protected Overrides Sub ClearControlsFromSession()
            ...
            Me.RemoveFromSession(Me.WCA_StatusFilter)
    ...
    Me.RemoveFromSession(Me, "Page_Size")
        ...
        Public Overridable Sub SetFiltersButton()                
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png"
            ...
            If (IsValueSelected(WCA_StatusFilter)) Then
    ...
    Try
        ...
        Public Overridable Sub WCA_Date_AssignLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ' Sorts by WCA_Date_Assign when clicked.
              
            ' Get previous sorting state for WCA_Date_Assign.
            
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Sel_WCAR_Activity_WCAR_DocView.WCA_Date_Assign)
            If sd Is Nothing OrElse (Me.CurrentSortOrder.Items IsNot Nothing Andalso Me.CurrentSortOrder.Items.Length > 1) Then
                ' First time sort, so add sort order for WCA_Date_Assign.
                Me.CurrentSortOrder.Reset()
              ...
              Me.CurrentSortOrder.Add(Sel_WCAR_Activity_WCAR_DocView.WCA_Date_Assign, OrderByItem.OrderDir.Asc)
            
            Else
                ' Previously sorted by WCA_Date_Assign, so just reverse.
                sd.Reverse()
            End If
        ...
        Public Overridable Sub WCA_StatusLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ' Sorts by WCA_Status when clicked.
              
            ' Get previous sorting state for WCA_Status.
            
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Sel_WCAR_Activity_WCAR_DocView.WCA_Status)
            If sd Is Nothing OrElse (Me.CurrentSortOrder.Items IsNot Nothing Andalso Me.CurrentSortOrder.Items.Length > 1) Then
                ' First time sort, so add sort order for WCA_Status.
                Me.CurrentSortOrder.Reset()
              ...
              Me.CurrentSortOrder.Add(Sel_WCAR_Activity_WCAR_DocView.WCA_Status, OrderByItem.OrderDir.Asc)
            
            Else
                ' Previously sorted by WCA_Status, so just reverse.
                sd.Reverse()
            End If
        ...
        Public Overridable Sub WCA_W_U_IDLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ' Sorts by WCA_W_U_ID when clicked.
              
            ' Get previous sorting state for WCA_W_U_ID.
            
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Sel_WCAR_Activity_WCAR_DocView.WCA_W_U_ID)
            If sd Is Nothing OrElse (Me.CurrentSortOrder.Items IsNot Nothing Andalso Me.CurrentSortOrder.Items.Length > 1) Then
                ' First time sort, so add sort order for WCA_W_U_ID.
                Me.CurrentSortOrder.Reset()
              ...
              Me.CurrentSortOrder.Add(Sel_WCAR_Activity_WCAR_DocView.WCA_W_U_ID, OrderByItem.OrderDir.Asc)
            
            Else
                ' Previously sorted by WCA_W_U_ID, so just reverse.
                sd.Reverse()
            End If
        ...
        Public Overridable Sub WCA_WDT_IDLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ' Sorts by WCA_WDT_ID when clicked.
              
            ' Get previous sorting state for WCA_WDT_ID.
            
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Sel_WCAR_Activity_WCAR_DocView.WCA_WDT_ID)
            If sd Is Nothing OrElse (Me.CurrentSortOrder.Items IsNot Nothing Andalso Me.CurrentSortOrder.Items.Length > 1) Then
                ' First time sort, so add sort order for WCA_WDT_ID.
                Me.CurrentSortOrder.Reset()
              ...
              Me.CurrentSortOrder.Add(Sel_WCAR_Activity_WCAR_DocView.WCA_WDT_ID, OrderByItem.OrderDir.Asc)
            
            Else
                ' Previously sorted by WCA_WDT_ID, so just reverse.
                sd.Reverse()
            End If
        ...
        Public Overridable Sub WCD_Exp_TotalLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ' Sorts by WCD_Exp_Total when clicked.
              
            ' Get previous sorting state for WCD_Exp_Total.
            
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Sel_WCAR_Activity_WCAR_DocView.WCD_Exp_Total)
            If sd Is Nothing OrElse (Me.CurrentSortOrder.Items IsNot Nothing Andalso Me.CurrentSortOrder.Items.Length > 1) Then
                ' First time sort, so add sort order for WCD_Exp_Total.
                Me.CurrentSortOrder.Reset()
              ...
              Me.CurrentSortOrder.Add(Sel_WCAR_Activity_WCAR_DocView.WCD_Exp_Total, OrderByItem.OrderDir.Asc)
            
            Else
                ' Previously sorted by WCD_Exp_Total, so just reverse.
                sd.Reverse()
            End If
        ...
        Public Overridable Sub WCD_NoLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ' Sorts by WCD_No when clicked.
              
            ' Get previous sorting state for WCD_No.
            
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Sel_WCAR_Activity_WCAR_DocView.WCD_No)
            If sd Is Nothing OrElse (Me.CurrentSortOrder.Items IsNot Nothing Andalso Me.CurrentSortOrder.Items.Length > 1) Then
                ' First time sort, so add sort order for WCD_No.
                Me.CurrentSortOrder.Reset()
              ...
              Me.CurrentSortOrder.Add(Sel_WCAR_Activity_WCAR_DocView.WCD_No, OrderByItem.OrderDir.Asc)
            
            Else
                ' Previously sorted by WCD_No, so just reverse.
                sd.Reverse()
            End If
        ...
        Public Overridable Sub WCD_Request_DateLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Sel_WCAR_Activity_WCAR_DocView.WCD_Request_Date)
            If sd Is Nothing OrElse (Me.CurrentSortOrder.Items IsNot Nothing Andalso Me.CurrentSortOrder.Items.Length > 1) Then
              ...
              Me.CurrentSortOrder.Add(Sel_WCAR_Activity_WCAR_DocView.WCD_Request_Date, OrderByItem.OrderDir.Asc)
        ...
        Public Overridable Sub WCD_WCur_IDLabel_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim sd As OrderByItem = Me.CurrentSortOrder.Find(Sel_WCAR_Activity_WCAR_DocView.WCD_WCur_ID)
            If sd Is Nothing OrElse (Me.CurrentSortOrder.Items IsNot Nothing Andalso Me.CurrentSortOrder.Items.Length > 1) Then
              ...
              Me.CurrentSortOrder.Add(Sel_WCAR_Activity_WCAR_DocView.WCD_WCur_ID, OrderByItem.OrderDir.Asc)
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            ' Create the Order By clause based on the user's current sorting preference.
              ...
              Me.TotalRecords = Sel_WCAR_Activity_WCAR_DocView.GetRecordCount(join, wc)
              If Me.TotalRecords > 10000 Then
          
              ' Add each of the columns in order of export.
              Dim columns() as BaseColumn = New BaseColumn() { _
                         Sel_WCAR_Activity_WCAR_DocView.WCA_WDT_ID, _ 
             Sel_WCAR_Activity_WCAR_DocView.WCA_W_U_ID, _ 
             Sel_WCAR_Activity_WCAR_DocView.WCA_Status, _ 
             Sel_WCAR_Activity_WCAR_DocView.WCA_Date_Assign, _ 
             Sel_WCAR_Activity_WCAR_DocView.WCD_No, _ 
             Sel_WCAR_Activity_WCAR_DocView.WCD_Project_Title, _ 
             Sel_WCAR_Activity_WCAR_DocView.WCD_Exp_Total, _ 
             Sel_WCAR_Activity_WCAR_DocView.WCD_WCur_ID, _ 
             Sel_WCAR_Activity_WCAR_DocView.WCD_Request_Date, _ 
             Nothing}
              Dim  exportData as ExportDataToCSV = New ExportDataToCSV(Sel_WCAR_Activity_WCAR_DocView.Instance, wc, orderBy, columns)
              exportData.StartExport(Me.Page.Response, True)

              Dim dataForCSV As DataForExport = New DataForExport(Sel_WCAR_Activity_WCAR_DocView.Instance, wc, orderBy, columns, join)
          ...
          Else
              ...
              Dim excelReport As ExportDataToExcel = New ExportDataToExcel(Sel_WCAR_Activity_WCAR_DocView.Instance, wc, orderBy)
              ' Add each of the columns in order of export.
              ...
              Dim data As DataForExport = New DataForExport(Sel_WCAR_Activity_WCAR_DocView.Instance, wc, orderBy, Nothing, join)
                       data.ColumnList.Add(New ExcelColumn(Sel_WCAR_Activity_WCAR_DocView.WCA_WDT_ID, "Default"))
             data.ColumnList.Add(New ExcelColumn(Sel_WCAR_Activity_WCAR_DocView.WCA_W_U_ID, "Default"))
             data.ColumnList.Add(New ExcelColumn(Sel_WCAR_Activity_WCAR_DocView.WCA_Status, "Default"))
             data.ColumnList.Add(New ExcelColumn(Sel_WCAR_Activity_WCAR_DocView.WCA_Date_Assign, "Short Date"))
             data.ColumnList.Add(New ExcelColumn(Sel_WCAR_Activity_WCAR_DocView.WCD_No, "Default"))
             data.ColumnList.Add(New ExcelColumn(Sel_WCAR_Activity_WCAR_DocView.WCD_Project_Title, "Default"))
             data.ColumnList.Add(New ExcelColumn(Sel_WCAR_Activity_WCAR_DocView.WCD_Exp_Total, "Standard"))
             data.ColumnList.Add(New ExcelColumn(Sel_WCAR_Activity_WCAR_DocView.WCD_WCur_ID, "Default"))
             data.ColumnList.Add(New ExcelColumn(Sel_WCAR_Activity_WCAR_DocView.WCD_Request_Date, "Short Date"))
                  ...
                  For Each rec As BaseRecord In recList
                      ...
                      For Each col As ExcelColumn In data.ColumnList
                          ...
                          If _isExpandableNonCompositeForeignKey AndAlso col.DisplayColumn.IsApplyDisplayAs Then
                              val = Sel_WCAR_Activity_WCAR_DocView.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, Nothing)
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-test.PDFButton.report")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "sel_WCAR_Activity_WCAR_Doc"
                ' If Show-test.PDFButton.report specifies a valid report template,
                ...
                ' The 5th parameter represents the relative width of the column   			
                 report.AddColumn(Sel_WCAR_Activity_WCAR_DocView.WCA_WDT_ID.Name, ReportEnum.Align.Left, "${WCA_WDT_ID}", ReportEnum.Align.Left, 18)
                 report.AddColumn(Sel_WCAR_Activity_WCAR_DocView.WCA_W_U_ID.Name, ReportEnum.Align.Left, "${WCA_W_U_ID}", ReportEnum.Align.Left, 22)
                 report.AddColumn(Sel_WCAR_Activity_WCAR_DocView.WCA_Status.Name, ReportEnum.Align.Left, "${WCA_Status}", ReportEnum.Align.Left, 28)
                 report.AddColumn(Sel_WCAR_Activity_WCAR_DocView.WCA_Date_Assign.Name, ReportEnum.Align.Left, "${WCA_Date_Assign}", ReportEnum.Align.Left, 20)
                 report.AddColumn(Sel_WCAR_Activity_WCAR_DocView.WCD_No.Name, ReportEnum.Align.Left, "${WCD_No}", ReportEnum.Align.Left, 28)
                 report.AddColumn(Sel_WCAR_Activity_WCAR_DocView.WCD_Project_Title.Name, ReportEnum.Align.Left, "${WCD_Project_Title}", ReportEnum.Align.Left, 28)
                 report.AddColumn(Sel_WCAR_Activity_WCAR_DocView.WCD_Exp_Total.Name, ReportEnum.Align.Right, "${WCD_Exp_Total}", ReportEnum.Align.Right, 20)
                 report.AddColumn(Sel_WCAR_Activity_WCAR_DocView.WCD_WCur_ID.Name, ReportEnum.Align.Left, "${WCD_WCur_ID}", ReportEnum.Align.Left, 19)
                 report.AddColumn(Sel_WCAR_Activity_WCAR_DocView.WCD_Request_Date.Name, ReportEnum.Align.Left, "${WCD_Request_Date}", ReportEnum.Align.Left, 20)
              ...
              Dim joinFilter As BaseFilter = CreateCompoundJoinFilter()
                ...
                Dim totalRows As Integer = Sel_WCAR_Activity_WCAR_DocView.GetRecordCount(joinFilter,whereClause)
                Dim columns As ColumnList = Sel_WCAR_Activity_WCAR_DocView.GetColumnList()
                Dim records As Sel_WCAR_Activity_WCAR_DocRecord() = Nothing
            
                Do 
                    
                    records = Sel_WCAR_Activity_WCAR_DocView.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery)
                    If Not (records Is Nothing) AndAlso records.Length > 0 AndAlso whereClause.RunQuery Then
                      For Each record As Sel_WCAR_Activity_WCAR_DocRecord In records 
                            ...
                            ' The 4th parameters represent the maximum length of the data value being shown
                             ...
                             Else 
                                 ...
                                 Dim _DFKA as String = ""
                                 _isExpandableNonCompositeForeignKey = Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Sel_WCAR_Activity_WCAR_DocView.WCA_WDT_ID)
                                 _DFKA = Sel_WCAR_Activity_WCAR_DocView.GetDFKA(record.WCA_WDT_ID.ToString(), Sel_WCAR_Activity_WCAR_DocView.WCA_WDT_ID,Nothing)
                                 If _isExpandableNonCompositeForeignKey AndAlso  (not _DFKA  Is Nothing)  AndAlso  Sel_WCAR_Activity_WCAR_DocView.WCA_WDT_ID.IsApplyDisplayAs Then
                                     report.AddData("${WCA_WDT_ID}", _DFKA,ReportEnum.Align.Left, 300)
                                 Else 
                                     report.AddData("${WCA_WDT_ID}", record.Format(Sel_WCAR_Activity_WCAR_DocView.WCA_WDT_ID), ReportEnum.Align.Left, 300)
                                 End If
                             End If
                             ...
                             Else 
                                 Dim _isExpandableNonCompositeForeignKey as Boolean
                                 Dim _DFKA as String = ""
                                 _isExpandableNonCompositeForeignKey = Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Sel_WCAR_Activity_WCAR_DocView.WCA_W_U_ID)
                                 _DFKA = Sel_WCAR_Activity_WCAR_DocView.GetDFKA(record.WCA_W_U_ID.ToString(), Sel_WCAR_Activity_WCAR_DocView.WCA_W_U_ID,Nothing)
                                 If _isExpandableNonCompositeForeignKey AndAlso  (not _DFKA  Is Nothing)  AndAlso  Sel_WCAR_Activity_WCAR_DocView.WCA_W_U_ID.IsApplyDisplayAs Then
                                     report.AddData("${WCA_W_U_ID}", _DFKA,ReportEnum.Align.Left, 300)
                                 Else 
                                     report.AddData("${WCA_W_U_ID}", record.Format(Sel_WCAR_Activity_WCAR_DocView.WCA_W_U_ID), ReportEnum.Align.Left, 300)
                                 End If
                             End If
                             report.AddData("${WCA_Status}", record.Format(Sel_WCAR_Activity_WCAR_DocView.WCA_Status), ReportEnum.Align.Left, 300)
                             report.AddData("${WCA_Date_Assign}", record.Format(Sel_WCAR_Activity_WCAR_DocView.WCA_Date_Assign), ReportEnum.Align.Left, 300)
                             report.AddData("${WCD_No}", record.Format(Sel_WCAR_Activity_WCAR_DocView.WCD_No), ReportEnum.Align.Left, 300)
                             report.AddData("${WCD_Project_Title}", record.Format(Sel_WCAR_Activity_WCAR_DocView.WCD_Project_Title), ReportEnum.Align.Left, 300)
                             report.AddData("${WCD_Exp_Total}", record.Format(Sel_WCAR_Activity_WCAR_DocView.WCD_Exp_Total), ReportEnum.Align.Right, 300)
                             If BaseClasses.Utils.MiscUtils.IsNull(record.WCD_WCur_ID) Then
                                 report.AddData("${WCD_WCur_ID}", "",ReportEnum.Align.Left, 300)
                             Else 
                                 Dim _isExpandableNonCompositeForeignKey as Boolean
                                 Dim _DFKA as String = ""
                                 _isExpandableNonCompositeForeignKey = Sel_WCAR_Activity_WCAR_DocView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Sel_WCAR_Activity_WCAR_DocView.WCD_WCur_ID)
                                 _DFKA = Sel_WCAR_Activity_WCAR_DocView.GetDFKA(record.WCD_WCur_ID.ToString(), Sel_WCAR_Activity_WCAR_DocView.WCD_WCur_ID,Nothing)
                                 If _isExpandableNonCompositeForeignKey AndAlso  (not _DFKA  Is Nothing)  AndAlso  Sel_WCAR_Activity_WCAR_DocView.WCD_WCur_ID.IsApplyDisplayAs Then
                                     report.AddData("${WCD_WCur_ID}", _DFKA,ReportEnum.Align.Left, 300)
                                 Else 
                                     report.AddData("${WCD_WCur_ID}", record.Format(Sel_WCAR_Activity_WCAR_DocView.WCD_WCur_ID), ReportEnum.Align.Left, 300)
                                 End If
                             End If
                             report.AddData("${WCD_Request_Date}", record.Format(Sel_WCAR_Activity_WCAR_DocView.WCD_Request_Date), ReportEnum.Align.Left, 300)
    ...
    Try
      ...
      ' Enclose all database retrieval/update code within a Transaction boundary
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-test.WordButton.word")
                ' report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "sel_WCAR_Activity_WCAR_Doc"
                ' If Show-test.WordButton.report specifies a valid report template,
                ' AddColumn method will generate a report template.
                ' Each AddColumn method-call specifies a column
                ' The 1st parameter represents the text of the column header
                ' The 2nd parameter represents the horizontal alignment of the column header
    ...
    Try
        ...
        Protected Overridable Sub WCA_StatusFilter_SelectedIndexChanged(ByVal sender As Object, ByVal args As EventArgs)
           ' Setting the DataChanged to True results in the page being refreshed with
           ' the most recent data from the database.  This happens in PreRender event
           ' based on the current sort, search and filter criteria.
           Me.DataChanged = True
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property WCA_Date_AssignLabel() As System.Web.UI.WebControls.LinkButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "WCA_Date_AssignLabel"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
        
        Public ReadOnly Property WCA_StatusFilter() As BaseClasses.Web.UI.WebControls.QuickSelector
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "WCA_StatusFilter"), BaseClasses.Web.UI.WebControls.QuickSelector)
            End Get
        End Property
        
        Public ReadOnly Property WCA_StatusLabel() As System.Web.UI.WebControls.LinkButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "WCA_StatusLabel"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
        ...
        Public ReadOnly Property WCA_W_U_IDLabel() As System.Web.UI.WebControls.LinkButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "WCA_W_U_IDLabel"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
        
        Public ReadOnly Property WCA_WDT_IDLabel() As System.Web.UI.WebControls.LinkButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "WCA_WDT_IDLabel"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
        
        Public ReadOnly Property WCD_Exp_TotalLabel() As System.Web.UI.WebControls.LinkButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "WCD_Exp_TotalLabel"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
        
        Public ReadOnly Property WCD_NoLabel() As System.Web.UI.WebControls.LinkButton
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "WCD_NoLabel"), System.Web.UI.WebControls.LinkButton)
            End Get
        End Property
