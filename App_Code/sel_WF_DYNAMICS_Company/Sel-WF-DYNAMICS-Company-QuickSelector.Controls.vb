...
' Sel_WF_DYNAMICS_Company_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
Namespace ePortalWFApproval.UI.Controls.Sel_WF_DYNAMICS_Company_QuickSelector
...
' Base class for the SelectorTableControlRow control on the Sel_WF_DYNAMICS_Company_QuickSelector page.
...
Public Class BaseSelectorTableControlRow
        ...
        Public Overridable Sub LoadData()        
            ...
            ' Load the data from the database into the DataSource DatabaseANFLO-WF%dbo.sel_WF_DYNAMICS_Company record.
            ...
            If Me.RecordUniqueId IsNot Nothing AndAlso Me.RecordUniqueId.Trim <> "" Then
                Me.DataSource = Sel_WF_DYNAMICS_CompanyView.GetRecord(Me.RecordUniqueId, True)
            ...
            Me.DataSource = New Sel_WF_DYNAMICS_CompanyRecord()
        ...
        Public Overridable Sub Delete()
          ...
          Sel_WF_DYNAMICS_CompanyView.DeleteRecord(pkValue)
        ...
        Public Property DataSource() As Sel_WF_DYNAMICS_CompanyRecord
            Get
                Return DirectCast(MyBase._DataSource, Sel_WF_DYNAMICS_CompanyRecord)
            End Get
            Set(ByVal value As Sel_WF_DYNAMICS_CompanyRecord)
...
#Region "Helper Functions"
        ...
        Public Overridable Function GetRecord() As Sel_WF_DYNAMICS_CompanyRecord
            ...
            If Not Me.RecordUniqueId Is Nothing Then
                ...
                Return Sel_WF_DYNAMICS_CompanyView.GetRecord(Me.RecordUniqueId, True)
...
' Base class for the SelectorTableControl control on the Sel_WF_DYNAMICS_Company_QuickSelector page.
...
Public Class BaseSelectorTableControl
    ...
    ' Setup default pagination settings.
        ...
        Public Overridable Sub LoadData()        
            ...
            Try	
                ...
                If wc IsNot Nothing AndAlso Not wc.RunQuery Then
                    ...
                    Me.DataSource = DirectCast(alist.ToArray(GetType(Sel_WF_DYNAMICS_CompanyRecord)), Sel_WF_DYNAMICS_CompanyRecord())
                ...
                ' Make sure to preserve the previously entered data on new rows.
                    ...
                    For Each rc As SelectorTableControlRow In Me.GetRecordControls()
                        ...
                        End If
                    Next
                    Me.DataSource = DirectCast(postdata.ToArray(GetType(Sel_WF_DYNAMICS_CompanyRecord)), Sel_WF_DYNAMICS_CompanyRecord())
        ...
        Public Overridable Function GetRecords( _
            ...
            ' selCols.Add(Sel_WF_DYNAMICS_CompanyView.Column1, True)         
            ' selCols.Add(Sel_WF_DYNAMICS_CompanyView.Column2, True)          
            ' selCols.Add(Sel_WF_DYNAMICS_CompanyView.Column3, True)    
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return Sel_WF_DYNAMICS_CompanyView.GetRecords(join, where, orderBy, Me.PageIndex, Me.PageSize)
                 
            Else
                Dim databaseTable As New Sel_WF_DYNAMICS_CompanyView
                ...
                Return CType(recList.ToArray(GetType(Sel_WF_DYNAMICS_CompanyRecord)), Sel_WF_DYNAMICS_CompanyRecord())
            End If            
        ...
        Public Overridable Function GetRecordCount(ByVal join As BaseFilter, ByVal where As WhereClause) As Integer
            ...
            If selCols.Count = 0 OrElse selCols.HasPrimaryKey Then
                ...
                Return Sel_WF_DYNAMICS_CompanyView.GetRecordCount(join, where)
        ...
        Public Overridable Function GetColumnListFromURLParameters(ByVal includeIndexFieldParameter As Boolean, ByVal includeFormulaAndDFKAParameter As Boolean) As ColumnList
            ...
            If includeIndexFieldParameter AndAlso field <> "" Then
                Dim col As BaseColumn = Sel_WF_DYNAMICS_CompanyView.GetColumnByName(field)
                If col IsNot Nothing  AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
            End If
            If includeFormulaAndDFKAParameter Then
                If formula <> "" Then
                    For Each col As BaseColumn In MiscUtils.GetFormulaFieldList(formula, Sel_WF_DYNAMICS_CompanyView.Instance.TableDefinition)
                        If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                    Next
                
                ElseIf displayFieldName <> ""
                    Dim col As BaseColumn = Sel_WF_DYNAMICS_CompanyView.GetColumnByName(displayFieldName)
                    If col IsNot Nothing AndAlso Not columnList.Contains(col) Then columnList.Add(col)             
                End If
            End If
            Return columnList            
    ...
    End Sub
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            Sel_WF_DYNAMICS_CompanyView.Instance.InnerFilter = Nothing
      ...
      Next
            ...
            End If
		        ...
		        If Not String.IsNullOrEmpty(Me.Page.Request("dependOnField")) AndAlso Me.Page.Request("dependOnVal") IsNot Nothing Then
			          Dim dependOnCol as BaseColumn = Sel_WF_DYNAMICS_CompanyView.GetColumnByName(Me.Page.GetDecryptedURLParameter("dependOnField"))
    ...
    End Function
      ...
      Next
        ...
        Public Overridable Function GetAutoCompletionList_Search(ByVal prefixText As String, ByVal count As Integer) As String()
            ...
            Dim recordList () As ePortalWFApproval.Business.Sel_WF_DYNAMICS_CompanyRecord = Sel_WF_DYNAMICS_CompanyView.GetRecords(filterJoin, wc, Nothing, 0, count,count)
            Dim rec As Sel_WF_DYNAMICS_CompanyRecord = Nothing
    ...
    Dim recControl As SelectorTableControlRow = DirectCast(repItem.FindControl("SelectorTableControlRow"), SelectorTableControlRow)
                    ...
                    If recControl.Visible AndAlso recControl.IsNewRecord() Then
                        Dim rec As Sel_WF_DYNAMICS_CompanyRecord = New Sel_WF_DYNAMICS_CompanyRecord()
            ...
            For index = 1 To Me.AddNewRecord
                ...
                newRecordList.Insert(0, New Sel_WF_DYNAMICS_CompanyRecord())
            ...
            If newRecordList.Count > 0 Then
                ...
                Me.DataSource = DirectCast(finalList.ToArray(GetType(Sel_WF_DYNAMICS_CompanyRecord)), Sel_WF_DYNAMICS_CompanyRecord())
 ...
 If Not Me.CurrentSortOrder Is Nothing Then
    ...
    Try
        ...
        Public Property TotalRecords() As Integer
            Get
                If _TotalRecords < 0 
                    _TotalRecords = Sel_WF_DYNAMICS_CompanyView.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause())
                End If
