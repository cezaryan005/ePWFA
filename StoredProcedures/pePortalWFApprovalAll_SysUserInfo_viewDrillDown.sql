if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalAll_SysUserInfo_viewDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalAll_SysUserInfo_viewDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalAll_SysUserInfo_viewDrillDown
