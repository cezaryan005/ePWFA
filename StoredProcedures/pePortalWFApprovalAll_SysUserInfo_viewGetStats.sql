if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalAll_SysUserInfo_viewGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalAll_SysUserInfo_viewGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalAll_SysUserInfo_viewGetStats
