if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_Approver_Pending_TasksDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_Approver_Pending_TasksDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_Approver_Pending_TasksDrillDown
