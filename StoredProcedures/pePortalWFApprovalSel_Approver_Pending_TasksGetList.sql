if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_Approver_Pending_TasksGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_Approver_Pending_TasksGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_Approver_Pending_TasksGetList
