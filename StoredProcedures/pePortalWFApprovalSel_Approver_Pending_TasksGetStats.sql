if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_Approver_Pending_TasksGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_Approver_Pending_TasksGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSel_Approver_Pending_TasksGetStats
