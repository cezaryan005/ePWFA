if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_CAR_Rpt_ActivityRemDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_CAR_Rpt_ActivityRemDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_CAR_Rpt_ActivityRemDrillDown
