if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_DYNAMICS_Company2DrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_DYNAMICS_Company2DrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_DYNAMICS_Company2DrillDown
