if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_DYNAMICS_Company2GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_DYNAMICS_Company2GetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_DYNAMICS_Company2GetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            N'sel_DYNAMICS_Company_.[Company_ID],
            sel_DYNAMICS_Company_.[Company_Desc],
            sel_DYNAMICS_Company_.[Company_Short_Name],
            sel_DYNAMICS_Company_.[INTERID],
            sel_DYNAMICS_Company_.[IsNonGP]'
