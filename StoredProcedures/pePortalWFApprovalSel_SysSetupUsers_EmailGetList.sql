if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_SysSetupUsers_EmailGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_SysSetupUsers_EmailGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_SysSetupUsers_EmailGetList
