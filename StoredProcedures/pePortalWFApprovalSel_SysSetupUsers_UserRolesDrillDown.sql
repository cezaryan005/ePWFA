if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_SysSetupUsers_UserRolesDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_SysSetupUsers_UserRolesDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_SysSetupUsers_UserRolesDrillDown
