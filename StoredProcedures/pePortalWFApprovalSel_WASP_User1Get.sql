if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WASP_User1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WASP_User1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WASP_User1Get
        @pk_W_U_ID int
AS
DECLARE
    @l_count int
