if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WASP_User1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WASP_User1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WASP_User1Update
    @pk_W_U_ID int,
