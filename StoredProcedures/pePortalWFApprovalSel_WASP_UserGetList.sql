if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WASP_UserGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WASP_UserGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_WASP_UserGetList
