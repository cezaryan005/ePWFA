if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WASP_WF_ApproverGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WASP_WF_ApproverGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_WASP_WF_ApproverGetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH sel_WASP_WF_Approver_ AS ( SELECT  '
        ...
        SET @l_query_select2 = 'SELECT * FROM sel_WASP_WF_Approver_ '
