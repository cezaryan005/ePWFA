if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WASP_WF_Approver_FSGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WASP_WF_Approver_FSGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSel_WASP_WF_Approver_FSGetStats
