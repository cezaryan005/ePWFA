if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WASS_Dynamics_CompaniesDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WASS_Dynamics_CompaniesDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WASS_Dynamics_CompaniesDrillDown
