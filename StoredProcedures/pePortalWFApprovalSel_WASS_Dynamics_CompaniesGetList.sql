if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WASS_Dynamics_CompaniesGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WASS_Dynamics_CompaniesGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_WASS_Dynamics_CompaniesGetList
