if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WASS_Dynamics_CompaniesGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WASS_Dynamics_CompaniesGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSel_WASS_Dynamics_CompaniesGetStats
