if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WASS_User_Dynamics_CompanyDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WASS_User_Dynamics_CompanyDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WASS_User_Dynamics_CompanyDrillDown
