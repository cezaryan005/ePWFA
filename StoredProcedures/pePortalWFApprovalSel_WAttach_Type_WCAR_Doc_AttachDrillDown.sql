if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WAttach_Type_WCAR_Doc_AttachDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WAttach_Type_WCAR_Doc_AttachDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WAttach_Type_WCAR_Doc_AttachDrillDown
