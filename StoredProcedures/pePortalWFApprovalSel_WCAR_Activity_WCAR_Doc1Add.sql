if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WCAR_Activity_WCAR_Doc1Add') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WCAR_Activity_WCAR_Doc1Add 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WCAR_Activity_WCAR_Doc1Add
    @p_WCA_ID int,
    @p_WCA_WS_ID int,
    @p_WCA_WSD_ID int,
    @p_WCA_WDT_ID int,
