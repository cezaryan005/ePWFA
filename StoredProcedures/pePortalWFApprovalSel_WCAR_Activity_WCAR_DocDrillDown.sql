if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WCAR_Activity_WCAR_DocDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WCAR_Activity_WCAR_DocDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WCAR_Activity_WCAR_DocDrillDown
