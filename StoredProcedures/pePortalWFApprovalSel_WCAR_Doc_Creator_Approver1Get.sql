if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WCAR_Doc_Creator_Approver1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WCAR_Doc_Creator_Approver1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WCAR_Doc_Creator_Approver1Get
        @pk_Row bigint
AS
DECLARE
    @l_count int
