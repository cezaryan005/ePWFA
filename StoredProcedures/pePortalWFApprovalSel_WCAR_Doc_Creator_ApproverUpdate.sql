if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WCAR_Doc_Creator_ApproverUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WCAR_Doc_Creator_ApproverUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WCAR_Doc_Creator_ApproverUpdate
    @p_WCD_ID int,
    @p_WCD_WDT_ID int,
    @p_WCD_No varchar(50),
    @p_WCD_Submit bit,
