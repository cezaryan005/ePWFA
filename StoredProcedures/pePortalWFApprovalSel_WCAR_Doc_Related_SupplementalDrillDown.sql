if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WCAR_Doc_Related_SupplementalDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WCAR_Doc_Related_SupplementalDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WCAR_Doc_Related_SupplementalDrillDown
