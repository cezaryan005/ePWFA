if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WCurrency_sel_WForeign_Exch_LatestDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WCurrency_sel_WForeign_Exch_LatestDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WCurrency_sel_WForeign_Exch_LatestDrillDown
