if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WCurrency_sel_WForeign_Exch_LatestGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WCurrency_sel_WForeign_Exch_LatestGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSel_WCurrency_sel_WForeign_Exch_LatestGetStats
