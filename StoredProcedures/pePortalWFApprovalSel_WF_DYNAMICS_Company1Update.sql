if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WF_DYNAMICS_Company1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WF_DYNAMICS_Company1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WF_DYNAMICS_Company1Update
    @p_Company_ID smallint,
    @pk_Company_ID smallint,
    @p_Company_Desc varchar(250),
    @p_Company_Short_Name varchar(65),
    @p_INTERID varchar(5),
