if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WF_Table_FieldsGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WF_Table_FieldsGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSel_WF_Table_FieldsGetList
