if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WPO_InquireDetailsExport') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WPO_InquireDetailsExport 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WPO_InquireDetailsExport
    ...
    BEGIN
        ...
        IF @p_select_str IS NULL
            ...
            SET @l_select_str = 
                ...
                N'IsNULL(Convert(nvarchar, sel_WPO_InquireDetails_.[WPOFR_Rate]), '''') + '' ''';
            END
