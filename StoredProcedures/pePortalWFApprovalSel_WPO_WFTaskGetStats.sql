if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WPO_WFTaskGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WPO_WFTaskGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSel_WPO_WFTaskGetStats
