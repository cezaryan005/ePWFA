if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WStep_WStep_DetailDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WStep_WStep_DetailDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_WStep_WStep_DetailDrillDown
