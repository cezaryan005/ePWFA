if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_WStep_WStep_DetailGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_WStep_WStep_DetailGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSel_WStep_WStep_DetailGetStats
