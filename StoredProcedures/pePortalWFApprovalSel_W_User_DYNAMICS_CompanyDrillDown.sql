if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSel_W_User_DYNAMICS_CompanyDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSel_W_User_DYNAMICS_CompanyDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSel_W_User_DYNAMICS_CompanyDrillDown
