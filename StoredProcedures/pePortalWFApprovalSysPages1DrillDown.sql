if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysPages1DrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysPages1DrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysPages1DrillDown
