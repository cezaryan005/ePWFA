if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysPages1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysPages1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysPages1Get
        @pk_PageID int
AS
DECLARE
    @l_count int
