if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysPages1GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysPages1GetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSysPages1GetList
