if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysPages1GetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysPages1GetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSysPages1GetStats
