if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysPagesAdd') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysPagesAdd 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysPagesAdd
