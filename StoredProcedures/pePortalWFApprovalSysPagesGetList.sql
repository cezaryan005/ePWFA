if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysPagesGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysPagesGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSysPagesGetList
