if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysPagesGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysPagesGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSysPagesGetStats
