if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupCompanyDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupCompanyDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysSetupCompanyDrillDown
