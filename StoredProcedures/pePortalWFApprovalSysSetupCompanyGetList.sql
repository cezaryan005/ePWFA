if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupCompanyGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupCompanyGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSysSetupCompanyGetList
