if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupCompanyGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupCompanyGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSysSetupCompanyGetStats
