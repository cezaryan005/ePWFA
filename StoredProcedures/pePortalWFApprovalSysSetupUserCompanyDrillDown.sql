if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUserCompanyDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUserCompanyDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysSetupUserCompanyDrillDown
