if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUserCompanyGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUserCompanyGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSysSetupUserCompanyGetList
