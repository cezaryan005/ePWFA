if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUserCompanyGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUserCompanyGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSysSetupUserCompanyGetStats
