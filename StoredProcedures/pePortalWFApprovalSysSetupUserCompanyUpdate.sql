if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUserCompanyUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUserCompanyUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysSetupUserCompanyUpdate
