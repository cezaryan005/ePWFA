if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUserCompany_viewDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUserCompany_viewDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysSetupUserCompany_viewDrillDown
