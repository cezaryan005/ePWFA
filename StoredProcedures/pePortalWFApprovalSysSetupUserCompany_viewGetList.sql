if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUserCompany_viewGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUserCompany_viewGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalSysSetupUserCompany_viewGetList
