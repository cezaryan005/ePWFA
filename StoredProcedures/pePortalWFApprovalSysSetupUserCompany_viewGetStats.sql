if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUserCompany_viewGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUserCompany_viewGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSysSetupUserCompany_viewGetStats
