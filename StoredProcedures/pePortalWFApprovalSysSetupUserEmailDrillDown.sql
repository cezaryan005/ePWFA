if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUserEmailDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUserEmailDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysSetupUserEmailDrillDown
