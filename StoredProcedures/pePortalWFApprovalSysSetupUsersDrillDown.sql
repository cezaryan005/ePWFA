if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUsersDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUsersDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalSysSetupUsersDrillDown
