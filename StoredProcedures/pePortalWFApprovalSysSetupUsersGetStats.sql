if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalSysSetupUsersGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalSysSetupUsersGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalSysSetupUsersGetStats
