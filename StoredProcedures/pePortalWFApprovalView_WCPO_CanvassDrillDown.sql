if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalView_WCPO_CanvassDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalView_WCPO_CanvassDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalView_WCPO_CanvassDrillDown
