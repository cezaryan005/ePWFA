if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWASS_Dynamics_Comp_Eq1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWASS_Dynamics_Comp_Eq1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalWASS_Dynamics_Comp_Eq1Get
        @pk_WDCE_ID int
AS
DECLARE
    @l_count int
