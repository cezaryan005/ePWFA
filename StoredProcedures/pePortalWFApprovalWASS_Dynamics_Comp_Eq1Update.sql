if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWASS_Dynamics_Comp_Eq1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWASS_Dynamics_Comp_Eq1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWASS_Dynamics_Comp_Eq1Update
    @pk_WDCE_ID int,
