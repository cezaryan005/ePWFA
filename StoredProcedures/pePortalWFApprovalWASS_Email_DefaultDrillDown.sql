if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWASS_Email_DefaultDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWASS_Email_DefaultDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWASS_Email_DefaultDrillDown
