if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWAttach_Type1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWAttach_Type1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWAttach_Type1Update
    @pk_WAT_ID smallint,
