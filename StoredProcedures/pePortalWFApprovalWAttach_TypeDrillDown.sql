if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWAttach_TypeDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWAttach_TypeDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWAttach_TypeDrillDown
