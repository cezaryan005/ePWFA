if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWAttach_TypeGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWAttach_TypeGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWAttach_TypeGetList
