if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWAttach_TypeGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWAttach_TypeGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWAttach_TypeGetStats
