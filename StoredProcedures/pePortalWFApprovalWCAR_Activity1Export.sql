if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_Activity1Export') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_Activity1Export 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCAR_Activity1Export
