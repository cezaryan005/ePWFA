if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_Activity1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_Activity1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCAR_Activity1Get
        @pk_WCA_ID int
AS
DECLARE
    @l_count int
