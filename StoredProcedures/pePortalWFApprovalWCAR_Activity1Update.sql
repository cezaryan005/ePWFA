if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_Activity1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_Activity1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCAR_Activity1Update
    @pk_WCA_ID int,
    @p_WCA_WS_ID int,
    @p_WCA_WSD_ID int,
    @p_WCA_WDT_ID int,
