if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_ActivityAdd') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_ActivityAdd 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCAR_ActivityAdd
    @p_WCA_WS_ID int,
    @p_WCA_WSD_ID int,
    @p_WCA_WDT_ID int,
    @p_WCA_W_U_ID int,
