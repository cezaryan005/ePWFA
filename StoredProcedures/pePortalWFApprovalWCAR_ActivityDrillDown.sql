if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_ActivityDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_ActivityDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCAR_ActivityDrillDown
