if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_ActivityGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_ActivityGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWCAR_ActivityGetStats
