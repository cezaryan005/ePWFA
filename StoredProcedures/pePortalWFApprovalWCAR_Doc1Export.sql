if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_Doc1Export') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_Doc1Export 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCAR_Doc1Export
