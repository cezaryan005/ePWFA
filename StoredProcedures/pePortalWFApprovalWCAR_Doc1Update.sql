if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_Doc1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_Doc1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCAR_Doc1Update
    @pk_WCD_ID int,
    @p_WCD_WDT_ID int,
    @p_WCD_No varchar(50),
    @p_WCD_Submit bit,
