if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_DocDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_DocDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCAR_DocDrillDown
