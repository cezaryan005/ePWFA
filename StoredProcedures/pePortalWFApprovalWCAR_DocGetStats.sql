if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_DocGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_DocGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWCAR_DocGetStats
