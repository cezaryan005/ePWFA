if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_Doc_Checker1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_Doc_Checker1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCAR_Doc_Checker1Update
    @pk_WCDC_ID int,
    @p_WCDC_WCD_ID int,
    @p_WCDC_U_ID int,
