if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_Doc_CheckerDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_Doc_CheckerDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCAR_Doc_CheckerDrillDown
