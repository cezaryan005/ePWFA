if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_Doc_CheckerGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_Doc_CheckerGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWCAR_Doc_CheckerGetList
