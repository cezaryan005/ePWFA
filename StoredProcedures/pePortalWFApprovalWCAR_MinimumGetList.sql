if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_MinimumGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_MinimumGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWCAR_MinimumGetList
