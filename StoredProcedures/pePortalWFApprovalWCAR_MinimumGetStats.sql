if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_MinimumGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_MinimumGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWCAR_MinimumGetStats
