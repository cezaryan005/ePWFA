if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCAR_MinimumUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCAR_MinimumUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCAR_MinimumUpdate
    @pk_WCM_ID smallint,
    @p_WCM_C_ID smallint,
