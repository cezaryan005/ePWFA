if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_PO_MapDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_PO_MapDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCanvass_PO_MapDrillDown
