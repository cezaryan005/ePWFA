if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_PO_MapGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_PO_MapGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWCanvass_PO_MapGetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH WCanvass_PO_Map_ AS ( SELECT  '
        ...
        SET @l_query_select2 = 'SELECT * FROM WCanvass_PO_Map_ '
