if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_PO_MapGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_PO_MapGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWCanvass_PO_MapGetStats
