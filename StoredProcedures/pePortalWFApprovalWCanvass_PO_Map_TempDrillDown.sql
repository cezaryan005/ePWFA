if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_PO_Map_TempDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_PO_Map_TempDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCanvass_PO_Map_TempDrillDown
