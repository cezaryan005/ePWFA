if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCanvass_PO_Map_TempGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCanvass_PO_Map_TempGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWCanvass_PO_Map_TempGetStats
