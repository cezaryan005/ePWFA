if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWClassificationGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWClassificationGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWClassificationGetStats
