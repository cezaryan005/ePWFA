if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCurrency1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCurrency1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWCurrency1Update
    @pk_WCur_ID smallint,
