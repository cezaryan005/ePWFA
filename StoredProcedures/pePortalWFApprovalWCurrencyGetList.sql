if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWCurrencyGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWCurrencyGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWCurrencyGetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH WCurrency_ AS ( SELECT  '
        ...
        SET @l_query_select2 = 'SELECT * FROM WCurrency_ '
