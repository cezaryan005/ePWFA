if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWDoc_Type1Add') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWDoc_Type1Add 
GO
...
CREATE PROCEDURE pePortalWFApprovalWDoc_Type1Add
    @p_WDT_C_ID smallint,
