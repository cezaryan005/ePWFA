if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWDoc_TypeGet') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWDoc_TypeGet 
GO
...
CREATE PROCEDURE pePortalWFApprovalWDoc_TypeGet
        @pk_WDT_ID int
AS
DECLARE
    @l_count int
