if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWDoc_TypeGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWDoc_TypeGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWDoc_TypeGetList
