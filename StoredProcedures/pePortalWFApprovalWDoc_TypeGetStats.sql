if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWDoc_TypeGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWDoc_TypeGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWDoc_TypeGetStats
