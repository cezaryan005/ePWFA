if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWDoc_TypeUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWDoc_TypeUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalWDoc_TypeUpdate
    @pk_WDT_ID int,
    @p_WDT_C_ID smallint,
