if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWF_Complete_NotifyGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWF_Complete_NotifyGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWF_Complete_NotifyGetList
