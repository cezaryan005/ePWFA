if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWF_Complete_NotifyGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWF_Complete_NotifyGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWF_Complete_NotifyGetStats
