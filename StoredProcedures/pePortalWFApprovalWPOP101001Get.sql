if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPOP101001Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPOP101001Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPOP101001Get
        @pk_WPOP_ID int
AS
DECLARE
    @l_count int
