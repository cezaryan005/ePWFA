if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPOP10100DrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPOP10100DrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPOP10100DrillDown
