if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPOP10100GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPOP10100GetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWPOP10100GetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH WPOP10100_ AS ( SELECT  '
        ...
        SET @l_query_select2 = 'SELECT * FROM WPOP10100_ '
