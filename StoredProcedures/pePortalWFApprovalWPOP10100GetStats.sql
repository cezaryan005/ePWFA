if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPOP10100GetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPOP10100GetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWPOP10100GetStats
