if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPOP10100Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPOP10100Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPOP10100Update
    @pk_WPOP_ID int,
    @p_WPOP_DT_ID int,
