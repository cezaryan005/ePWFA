if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_ActivityDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_ActivityDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPO_ActivityDrillDown
