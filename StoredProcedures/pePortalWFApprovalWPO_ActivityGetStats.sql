if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_ActivityGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_ActivityGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWPO_ActivityGetStats
