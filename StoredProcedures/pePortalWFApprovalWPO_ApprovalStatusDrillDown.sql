if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_ApprovalStatusDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_ApprovalStatusDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPO_ApprovalStatusDrillDown
