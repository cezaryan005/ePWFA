if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_ApprovalStatusGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_ApprovalStatusGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWPO_ApprovalStatusGetStats
