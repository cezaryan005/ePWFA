if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_CARNo_QDetails1Export') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_CARNo_QDetails1Export 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPO_CARNo_QDetails1Export
    ...
    BEGIN
        ...
        IF @p_select_str IS NULL
            ...
            SET @l_select_str = 
                ...
                N'N''"'' + REPLACE(IsNULL(WPO_CARNo_QDetails_.[WCD_Remark], ''''), N''"'', N''""'') + N''"''  + ''' + @p_separator_str + ''' +' +
