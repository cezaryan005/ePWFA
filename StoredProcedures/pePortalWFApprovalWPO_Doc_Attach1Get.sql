if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_Doc_Attach1Get') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_Doc_Attach1Get 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPO_Doc_Attach1Get
        @pk_WPODA_ID int
AS
DECLARE
    @l_count int
