if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_Doc_AttachGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_Doc_AttachGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWPO_Doc_AttachGetList
