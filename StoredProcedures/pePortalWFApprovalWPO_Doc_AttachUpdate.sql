if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_Doc_AttachUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_Doc_AttachUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPO_Doc_AttachUpdate
    @pk_WPODA_ID int,
