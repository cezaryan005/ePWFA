if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_Doc_TypeGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_Doc_TypeGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWPO_Doc_TypeGetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            CAST(BINARY_CHECKSUM(WPO_Doc_Type_.[WPO_DT_ID],WPO_Doc_Type_.[WPO_DT_C_ID],WPO_Doc_Type_.[WPO_DT_Name],WPO_Doc_Type_.[WPO_DT_Desc],WPO_Doc_Type_.[WPO_DT_Type],WPO_Doc_Type_.[WPO_DT_Limit],WPO_Doc_Type_.[WPO_DT_Minimum],WPO_Doc_Type_.[WPO_DT_Maximum]) AS nvarchar(max)) AS IS_CHECKSUM_COLUMN_12345'
