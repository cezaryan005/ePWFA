if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_PRNo_QDetailsGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_PRNo_QDetailsGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWPO_PRNo_QDetailsGetStats
