if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_StepGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_StepGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWPO_StepGetList
