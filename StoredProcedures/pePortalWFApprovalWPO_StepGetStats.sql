if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_StepGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_StepGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWPO_StepGetStats
