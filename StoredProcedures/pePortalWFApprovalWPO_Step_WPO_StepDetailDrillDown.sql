if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_Step_WPO_StepDetailDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_Step_WPO_StepDetailDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPO_Step_WPO_StepDetailDrillDown
