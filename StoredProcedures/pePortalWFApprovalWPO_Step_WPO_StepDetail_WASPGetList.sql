if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_Step_WPO_StepDetail_WASPGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_Step_WPO_StepDetail_WASPGetList 
GO
...
-- Returns a query resultset from table [dbo].[WPO_Step_WPO_StepDetail_WASP]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWPO_Step_WPO_StepDetail_WASPGetList
...
BEGIN
    ...
    [WPO_S_WDT_ID] int,
    [WPO_S_ID_Next] int,
    [WPO_S_Step_Type] varchar(20) COLLATE Latin1_General_BIN,
    [WPO_S_Approval_Needed] smallint,
    [WPO_SD_ID] int,
    [WPO_SD_W_U_ID] int,
    [WPO_SD_Is_FAP] bit,
    [W_U_Full_Name] varchar(125) COLLATE Latin1_General_BIN
        ...
        SET @l_temp_colsWithAlias = 
            N'WPO_Step_WPO_StepDetail_WASP_.[WPO_S_ID],
            WPO_Step_WPO_StepDetail_WASP_.[WPO_S_WDT_ID],
            WPO_Step_WPO_StepDetail_WASP_.[WPO_S_ID_Next],
            WPO_Step_WPO_StepDetail_WASP_.[WPO_S_Step_Type],
            WPO_Step_WPO_StepDetail_WASP_.[WPO_S_Approval_Needed],
            WPO_Step_WPO_StepDetail_WASP_.[WPO_SD_ID],
            WPO_Step_WPO_StepDetail_WASP_.[WPO_SD_W_U_ID],
            WPO_Step_WPO_StepDetail_WASP_.[WPO_SD_Is_FAP],
            WPO_Step_WPO_StepDetail_WASP_.[W_U_Full_Name]'
        SET @l_temp_from = 
            ' FROM ' + @l_from_str + ' ' + @l_join_str + ' ' + 
            @l_where_str + ' ' + 
            @l_sort_str
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            WPO_Step_WPO_StepDetail_WASP_.[W_U_Full_Name]'
        SET @l_query_from = 
            ' FROM [dbo].[WPO_Step_WPO_StepDetail_WASP] WPO_Step_WPO_StepDetail_WASP_ ' + 
            'WHERE 1=2;'
