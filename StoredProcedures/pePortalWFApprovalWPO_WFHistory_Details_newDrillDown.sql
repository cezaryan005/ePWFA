if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_WFHistory_Details_newDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_WFHistory_Details_newDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPO_WFHistory_Details_newDrillDown
