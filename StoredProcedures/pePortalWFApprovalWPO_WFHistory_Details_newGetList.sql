if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_WFHistory_Details_newGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_WFHistory_Details_newGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWPO_WFHistory_Details_newGetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH WPO_WFHistory_Details_new_ AS ( SELECT  '
        ...
        SET @l_query_select2 = 'SELECT * FROM WPO_WFHistory_Details_new_ '
