if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPO_WFHistory_Details_newGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPO_WFHistory_Details_newGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWPO_WFHistory_Details_newGetStats
