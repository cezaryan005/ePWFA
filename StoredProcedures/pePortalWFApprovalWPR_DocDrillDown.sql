if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_DocDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_DocDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPR_DocDrillDown
