if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_DocGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_DocGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWPR_DocGetList
