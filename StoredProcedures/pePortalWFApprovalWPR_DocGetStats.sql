if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_DocGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_DocGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWPR_DocGetStats
