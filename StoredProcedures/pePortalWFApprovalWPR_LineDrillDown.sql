if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWPR_LineDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWPR_LineDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWPR_LineDrillDown
