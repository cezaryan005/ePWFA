if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWStep1Export') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWStep1Export 
GO
...
CREATE PROCEDURE pePortalWFApprovalWStep1Export
