if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWStepAdd') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWStepAdd 
GO
...
CREATE PROCEDURE pePortalWFApprovalWStepAdd
    @p_WS_WDT_ID int,
    @p_WS_ID_Next int,
