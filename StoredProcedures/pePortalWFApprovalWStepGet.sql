if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWStepGet') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWStepGet 
GO
...
CREATE PROCEDURE pePortalWFApprovalWStepGet
        @pk_WS_ID int
AS
DECLARE
    @l_count int
