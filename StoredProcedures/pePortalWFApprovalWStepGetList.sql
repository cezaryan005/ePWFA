if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWStepGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWStepGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWStepGetList
