if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWStepGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWStepGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWStepGetStats
