if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWStepUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWStepUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalWStepUpdate
    @pk_WS_ID int,
    @p_WS_WDT_ID int,
    @p_WS_ID_Next int,
