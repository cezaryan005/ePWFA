if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWStep_Detail1Add') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWStep_Detail1Add 
GO
...
CREATE PROCEDURE pePortalWFApprovalWStep_Detail1Add
    @p_WSD_WS_ID int,
    @p_WSD_W_U_ID int,
