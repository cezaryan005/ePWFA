if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWStep_Detail1Export') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWStep_Detail1Export 
GO
...
CREATE PROCEDURE pePortalWFApprovalWStep_Detail1Export
