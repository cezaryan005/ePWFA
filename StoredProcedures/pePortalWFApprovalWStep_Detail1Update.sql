if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWStep_Detail1Update') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWStep_Detail1Update 
GO
...
CREATE PROCEDURE pePortalWFApprovalWStep_Detail1Update
    @pk_WSD_ID int,
    @p_WSD_WS_ID int,
    @p_WSD_W_U_ID int,
