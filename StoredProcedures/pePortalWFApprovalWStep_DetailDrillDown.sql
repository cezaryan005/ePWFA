if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWStep_DetailDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWStep_DetailDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalWStep_DetailDrillDown
