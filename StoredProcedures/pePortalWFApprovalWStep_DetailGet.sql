if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWStep_DetailGet') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWStep_DetailGet 
GO
...
CREATE PROCEDURE pePortalWFApprovalWStep_DetailGet
        @pk_WSD_ID int
AS
DECLARE
    @l_count int
