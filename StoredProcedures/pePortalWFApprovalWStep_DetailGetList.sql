if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWStep_DetailGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWStep_DetailGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalWStep_DetailGetList
