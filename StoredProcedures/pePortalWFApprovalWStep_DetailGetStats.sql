if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWStep_DetailGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWStep_DetailGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalWStep_DetailGetStats
