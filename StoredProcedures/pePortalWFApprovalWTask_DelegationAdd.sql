if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWTask_DelegationAdd') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWTask_DelegationAdd 
GO
...
CREATE PROCEDURE pePortalWFApprovalWTask_DelegationAdd
    @p_WTD_W_U_ID int,
