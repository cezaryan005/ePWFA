if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalWTask_DelegationUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalWTask_DelegationUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalWTask_DelegationUpdate
    @pk_WTD_ID int,
    @p_WTD_W_U_ID int,
