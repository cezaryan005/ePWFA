if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_Email1GetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_Email1GetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalW_Email1GetList
