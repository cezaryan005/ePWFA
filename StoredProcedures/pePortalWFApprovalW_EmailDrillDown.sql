if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_EmailDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_EmailDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalW_EmailDrillDown
