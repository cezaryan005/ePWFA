if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_EmailGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_EmailGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalW_EmailGetStats
