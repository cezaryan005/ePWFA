if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_Email_DefaultDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_Email_DefaultDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalW_Email_DefaultDrillDown
