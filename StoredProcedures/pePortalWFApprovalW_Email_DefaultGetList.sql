if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_Email_DefaultGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_Email_DefaultGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalW_Email_DefaultGetList
