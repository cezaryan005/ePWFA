if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_Email_DefaultGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_Email_DefaultGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalW_Email_DefaultGetStats
