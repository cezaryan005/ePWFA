if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_Email_DefaultUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_Email_DefaultUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalW_Email_DefaultUpdate
    @pk_WED_ID int,
