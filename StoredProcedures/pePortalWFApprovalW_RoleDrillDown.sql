if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_RoleDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_RoleDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalW_RoleDrillDown
