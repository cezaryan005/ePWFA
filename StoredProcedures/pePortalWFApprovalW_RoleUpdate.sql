if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_RoleUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_RoleUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalW_RoleUpdate
    @pk_W_R_ID int,
    @p_W_R_A_ID smallint,
