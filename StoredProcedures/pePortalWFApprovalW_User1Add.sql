if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_User1Add') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_User1Add 
GO
...
CREATE PROCEDURE pePortalWFApprovalW_User1Add
