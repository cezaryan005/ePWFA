if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_UserDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_UserDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalW_UserDrillDown
