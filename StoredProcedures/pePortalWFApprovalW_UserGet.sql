if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_UserGet') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_UserGet 
GO
...
CREATE PROCEDURE pePortalWFApprovalW_UserGet
        @pk_W_U_ID int
AS
DECLARE
    @l_count int
