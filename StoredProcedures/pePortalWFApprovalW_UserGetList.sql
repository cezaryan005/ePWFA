if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_UserGetList') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_UserGetList 
GO
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pePortalWFApprovalW_UserGetList
