if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_UserUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_UserUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalW_UserUpdate
    @pk_W_U_ID int,
