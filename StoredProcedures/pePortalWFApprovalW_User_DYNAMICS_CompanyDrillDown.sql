if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_User_DYNAMICS_CompanyDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_User_DYNAMICS_CompanyDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalW_User_DYNAMICS_CompanyDrillDown
