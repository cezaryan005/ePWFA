if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_User_DYNAMICS_CompanyGetStats') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_User_DYNAMICS_CompanyGetStats 
GO
...
-- sum, avg, max, etc
CREATE PROCEDURE pePortalWFApprovalW_User_DYNAMICS_CompanyGetStats
