if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_User_DYNAMICS_CompanyUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_User_DYNAMICS_CompanyUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalW_User_DYNAMICS_CompanyUpdate
    @pk_W_UDC_ID int,
    @p_W_UDC_U_ID int,
