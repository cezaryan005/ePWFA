if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_User_RoleDrillDown') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_User_RoleDrillDown 
GO
...
CREATE PROCEDURE pePortalWFApprovalW_User_RoleDrillDown
