if exists (select * from sysobjects where id = object_id(N'pePortalWFApprovalW_User_RoleUpdate') and sysstat & 0xf = 4) drop procedure pePortalWFApprovalW_User_RoleUpdate 
GO
...
CREATE PROCEDURE pePortalWFApprovalW_User_RoleUpdate
    @pk_W_UR_ID int,
    @p_W_UR_U_ID int,
    @p_W_UR_R_ID int,
