<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.SysPages_QuickSelector1" %>
...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="SysPages-QuickSelector1.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="ePortalWFApproval.UI.SysPages_QuickSelector1" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
