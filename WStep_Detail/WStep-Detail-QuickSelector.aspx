...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="WStep-Detail-QuickSelector.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="ePortalWFApproval.UI.WStep_Detail_QuickSelector" %>
<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %>
<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.WStep_Detail_QuickSelector" %>
