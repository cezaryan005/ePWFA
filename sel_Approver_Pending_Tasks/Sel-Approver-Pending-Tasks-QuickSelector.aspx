...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Sel-Approver-Pending-Tasks-QuickSelector.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="ePortalWFApproval.UI.Sel_Approver_Pending_Tasks_QuickSelector" %>
<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.Sel_Approver_Pending_Tasks_QuickSelector" %>
