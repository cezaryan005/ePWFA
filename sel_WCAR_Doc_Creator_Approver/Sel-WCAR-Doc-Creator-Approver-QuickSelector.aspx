<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.Sel_WCAR_Doc_Creator_Approver_QuickSelector" %>
...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Sel-WCAR-Doc-Creator-Approver-QuickSelector.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="ePortalWFApproval.UI.Sel_WCAR_Doc_Creator_Approver_QuickSelector" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
