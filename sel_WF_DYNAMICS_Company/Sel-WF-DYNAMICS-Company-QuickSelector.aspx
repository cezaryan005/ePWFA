...
<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Sel-WF-DYNAMICS-Company-QuickSelector.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="ePortalWFApproval.UI.Sel_WF_DYNAMICS_Company_QuickSelector" %>
<%@ Register Tagprefix="ePortalWFApproval" TagName="ThemeButton" Src="../Shared/ThemeButton.ascx" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Tagprefix="ePortalWFApproval" Namespace="ePortalWFApproval.UI.Controls.Sel_WF_DYNAMICS_Company_QuickSelector" %>
